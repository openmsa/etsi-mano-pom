...
public interface VnfSubscription {
	...
	void vnfPackageChangeNotificationPost(String body);
	...
	void vnfPackageOnboardingNotificationPost(String body);
	...
	List<InlineResponse2001> subscriptionsPost(String accept, String contentType, String body, UriInfo uriInfo);
	...
	String subscriptionsSubscriptionIdGet(String subscriptionId, String accept);
