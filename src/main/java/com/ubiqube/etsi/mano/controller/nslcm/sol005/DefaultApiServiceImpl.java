...
public class DefaultApiServiceImpl extends BaseApi implements DefaultApi {
	...
	public void nslcmV1NsLcmOpOccsNsLcmOpOccIdCancelPost(@PathParam("nsLcmOpOccId") String nsLcmOpOccId, @HeaderParam("Accept") String accept, @HeaderParam("Content-Type") String contentType, NslcmV1NsLcmOpOccsNsLcmOpOccIdCancelPostQuery body, @Context SecurityContext securityContext) {
		// TODO: Implement...
	...
	public SubscriptionsPost subscriptionsPost(@HeaderParam("Accept") String accept, @HeaderParam("Content-Type") String contentType, SubscriptionsPostQuery body, @Context SecurityContext securityContext) {
		// TODO: Implement...
	...
	public void uRIIsProvidedByTheClientWhenCreatingTheSubscriptionNsIdentifierCreationNotificationPost(NsIdentifierCreationNotification nsIdentifierCreationNotification, @HeaderParam("Accept") String accept, @HeaderParam("Content-Type") String contentType, @Context SecurityContext securityContext) {
		// TODO: Implement...
	...
	public void uRIIsProvidedByTheClientWhenCreatingTheSubscriptionNsIdentifierDeletionNotificationPost(NsIdentifierDeletionNotification nsIdentifierDeletionNotification, @HeaderParam("Accept") String accept, @HeaderParam("Content-Type") String contentType, @Context SecurityContext securityContext) {
		// TODO: Implement...
	...
	public void uRIIsProvidedByTheClientWhenCreatingTheSubscriptionNsLcmOperationOccurrenceNotificationPost(NsLcmOperationOccurrenceNotification nsLcmOperationOccurrenceNotification, @HeaderParam("Accept") String accept, @HeaderParam("Content-Type") String contentType, @Context SecurityContext securityContext) {
		// TODO: Implement...
