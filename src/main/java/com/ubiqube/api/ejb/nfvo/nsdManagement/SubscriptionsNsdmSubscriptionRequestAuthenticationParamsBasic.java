...
public class SubscriptionsNsdmSubscriptionRequestAuthenticationParamsBasic  {
  ...
  **/
  ...
  public SubscriptionsNsdmSubscriptionRequestAuthenticationParamsBasic userName(String userName) {
    this.userName = userName;
    return this;
  }
  ...
  **/
  ...
  public SubscriptionsNsdmSubscriptionRequestAuthenticationParamsBasic password(String password) {
    this.password = password;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class SubscriptionsNsdmSubscriptionRequestAuthenticationParamsBasic {\n");
