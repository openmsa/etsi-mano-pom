...
public class SubscriptionRepository {
	...
	public SubscriptionRepository(SubscriptionsPkgmSubscriptionRequestAuthentication _subscriptionsPkgmSubscriptionRequestAuthentication, SubscriptionsPkgmSubscription _subscriptionsPkgmSubscription) {
		super();
