...
@XmlEnumValue("INSTANTIATE") INSTANTIATE(String.valueOf("INSTANTIATE")), @XmlEnumValue("SCALE") SCALE(String.valueOf("SCALE")), @XmlEnumValue("UPDATE") UPDATE(String.valueOf("UPDATE")), @XmlEnumValue("TERMINATE") TERMINATE(String.valueOf("TERMINATE")), @XmlEnumValue("HEAL") HEAL(String.valueOf("HEAL"));
    ...
    public static LcmOperationTypeEnum fromValue(String v) {
...
@XmlEnumValue("INSTANTIATE") INSTANTIATE(String.valueOf("INSTANTIATE")), @XmlEnumValue("SCALE") SCALE(String.valueOf("SCALE")), @XmlEnumValue("UPDATE") UPDATE(String.valueOf("UPDATE")), @XmlEnumValue("HEAL") HEAL(String.valueOf("HEAL")), @XmlEnumValue("TERMINATE") TERMINATE(String.valueOf("TERMINATE"));


    private String value;

    OperationParamsEnum (String v) {
        value = v;
    }
    ...
    public static OperationParamsEnum fromValue(String v) {
...
@XmlEnumValue("GRACEFUL") GRACEFUL(String.valueOf("GRACEFUL")), @XmlEnumValue("FORCEFUL") FORCEFUL(String.valueOf("FORCEFUL"));
  ...
  **/
  ...
  public NsLcmOpOccsNsLcmOpOcc stateEnteredTime(Date stateEnteredTime) {
    this.stateEnteredTime = stateEnteredTime;
    return this;
  }
  ...
  **/
  ...
  public NsLcmOpOccsNsLcmOpOcc startTime(Date startTime) {
    this.startTime = startTime;
    return this;
  }
  ...
  **/
  ...
  public void setLinks(NsLcmOpOccsNsLcmOpOccLinks links) {
    this.links = links;
  }

  public NsLcmOpOccsNsLcmOpOcc links(NsLcmOpOccsNsLcmOpOccLinks links) {
    this.links = links;
    return this;
  }
