...
public class vnfPackagesVnfPkgIdPackageContentUploadFromUriPostResponse {
	  ...
	  **/
	  ...
	  public void setUserDefinedData(Object _userDefinedData) {
	    this.userDefinedData = _userDefinedData;
	  }

	  public vnfPackagesVnfPkgIdPackageContentUploadFromUriPostResponse userDefinedData(Object _userDefinedData) {
	    this.userDefinedData = _userDefinedData;
	    return this;
	  }
	  ...
	  public String toString() {
	    ...
	    sb.append("class vnfPackagesVnfPkgIdPackageContentUploadFromUriPostResponse {\n");
