...
@XmlEnumValue("NOT_INSTANTIATED") NOT_INSTANTIATED(String.valueOf("NOT_INSTANTIATED")), @XmlEnumValue("INSTANTIATED") INSTANTIATED(String.valueOf("INSTANTIATED"));
    ...
    public static NsStateEnum fromValue(String v) {
  ...
  **/
  ...
  public void setLinks(NsInstancesNsInstanceLinks links) {
    this.links = links;
  }

  public NsInstancesNsInstance links(NsInstancesNsInstanceLinks links) {
    this.links = links;
    return this;
  }
