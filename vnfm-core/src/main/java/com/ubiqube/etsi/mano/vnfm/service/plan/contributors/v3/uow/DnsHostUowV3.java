 ...
 *
 */
public class DnsHostUowV3 extends AbstractVnfmUowV3<DnsHostTask> {
	private final Vim vim;
	private final VimConnectionInformation vimConnectionInformation;
	private final DnsHostTask task;

	protected DnsHostUowV3(final VirtualTaskV3<DnsHostTask> task, final Vim vim, final VimConnectionInformation vimConnectionInformation) {
