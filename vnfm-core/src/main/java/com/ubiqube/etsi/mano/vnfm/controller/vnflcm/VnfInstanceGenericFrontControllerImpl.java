...
public class VnfInstanceGenericFrontControllerImpl implements VnfInstanceGenericFrontController {
	...
	@Override
	public <U> ResponseEntity<U> create(final @Nonnull String vnfdId, final String vnfInstanceName, final @Nullable String vnfInstanceDescription, final Function<VnfInstance, U> func, final Consumer<U> makeLink, final String selfLink) {
	...
	@Override
	public <U> ResponseEntity<String> search(final MultiValueMap<String, String> requestParams, final Function<VnfInstance, U> mapper, final @Nullable String nextpageOpaqueMarker, final Consumer<U> makeLink, final Class<?> frontClass) {
