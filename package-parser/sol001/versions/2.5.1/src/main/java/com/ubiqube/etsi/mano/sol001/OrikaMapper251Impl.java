 ...
 *
 */
public class OrikaMapper251Impl implements OrikaMapper {

	private static final String MONITORING_PARAMETERS_NAME = "monitoringParameters{name}";
	private static final String MONITORING_PARAMETERS_KEY = "monitoringParameters{key}";
	private static final String MONITORING_PARAMETERS = "monitoringParameters{}";
	private static final String MONITORING_PARAMETERS_VALUE = "monitoringParameters{value}";
	...
	public void configureMapper(final MapperFactory mapper) {
		mapper.classMap(VnfVirtualLink.class, tosca.nodes.nfv.VnfVirtualLink.class)
				.field(MONITORING_PARAMETERS_VALUE, MONITORING_PARAMETERS)
				.field(MONITORING_PARAMETERS_KEY, MONITORING_PARAMETERS_NAME)
				.byDefault()
				.register();
