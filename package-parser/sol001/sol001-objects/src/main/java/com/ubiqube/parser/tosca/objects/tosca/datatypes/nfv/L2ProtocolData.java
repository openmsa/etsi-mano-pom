...
/**
 * describes L2 protocol data for a given virtual link used in a specific VNF
 * deployment flavour.
 */
public class L2ProtocolData extends Root {
	/**
	...
	public void setVlanTransparent(@NotNull final Boolean vlanTransparent) {
