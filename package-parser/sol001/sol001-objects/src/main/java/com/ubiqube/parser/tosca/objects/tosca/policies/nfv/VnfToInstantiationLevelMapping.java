...
/**
 * The VnfToInstantiationLevelMapping type is a policy type representing the
 * number of VNF instances to be deployed at each NS instantiation level, as
 * defined in ETSI GS NFV-IFA 014 [2]tosca.nodes.nfv.VNF
 */
