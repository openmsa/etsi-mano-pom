...
/**
 * The AffinityRule describes the affinity rules applicable for the defined
...
public class AffinityRule extends Placement {
	 ...
	 * group of instances based on the same Vdu.Compute (for VM based VDU) node is
	 * impacted during NFVI operation and maintenance (e.g. NFVI resource upgrades).
	 */
	@Valid
