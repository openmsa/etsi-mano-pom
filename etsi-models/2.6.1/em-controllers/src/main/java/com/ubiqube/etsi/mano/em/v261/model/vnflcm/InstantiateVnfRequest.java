...
public class InstantiateVnfRequest {
	...
	public InstantiateVnfRequest additionalParams(final Map<String, Object> additionalParams) {
	...
	public InstantiateVnfRequest extensions(final Map<String, Object> extensions) {
	...
	@Override
	public int hashCode() {
		return Objects.hash(flavourId, instantiationLevelId, extVirtualLinks, extManagedVirtualLinks, localizationLanguage, additionalParams, extensions);
	}
