...
import com.ubiqube.etsi.mano.em.v261.model.vnfconfig.VnfConfigModifications;
import com.ubiqube.etsi.mano.em.v261.model.vnfconfig.VnfConfiguration;
...
@Api(description = "configuration", description = "the configuration API")
public interface Configuration261Sol002Api {
	...
	@ApiOperation(description = "Read VNF/VNFC configuration from VNF", nickname = "configurationGet", notes = "The client can use this method to read configuration information about a VNF instance and/or its VNFC instances. ", response = VnfConfiguration.class, tags = {})
	@ApiResponses(value = {
	...
	@ApiOperation(description = "Modify VNF/VNFC configuration.", nickname = "configurationPatch", notes = "This method sets or modifies a configuration resource.", response = VnfConfigModifications.class, tags = {})
	@ApiResponses(value = {
			...
			@ApiResponse(code = 503, message = "503 SERVICE UNAVAILABLE If the API producer encounters an internal overload situation of itself or of a system it relies on, it should respond with this response code, following the provisions in IETF RFC 7231 for the use of the \"Retry-After\" HTTP header and for the alternative to refuse the connection. The \"ProblemDetails\" structure may be omitted. ", response = ProblemDetails.class),
			@ApiResponse(code = 504, message = "504 GATEWAY TIMEOUT If the API producer encounters a timeout while waiting for a response from an upstream server (i.e. a server that the API producer communicates with when fulfilling a request), it should respond with this response code. ", response = ProblemDetails.class) })
	@RequestMapping(description = "/configuration", produces = { "application/json" }, consumes = { "application/json" }, method = RequestMethod.PATCH)
	default ResponseEntity<VnfConfigModifications> configurationPatch(@ApiParam(description = "Version of the API requested to use when responding to this request. ", required = true) @RequestHeader(value = "Version", required = true) final String version, @ApiParam(value = "The parameter for the configuration modification, as defined in clause 9.5.2.2. ", required = true) @Valid @RequestBody final VnfConfigModifications configModifications, @ApiParam(value = "The authorization token for the request. Reference: IETF RFC 7235 ") @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue(
