...
public class VnfInstance {
	 ...
	 * @return vnfPkgInfoId
	 **/
	@Schema(required = true, description = "Identifier of information held by the NFVO about the specific VNF package on which the VNF is based. This identifier was allocated by the NFVO. This attribute can be modified with the PATCHmethod. ")
	@NotNull
