...
public interface AlarmNotification261Sol003Api {
	...
	ResponseEntity<Void> alarmNotificationPost(
			@Parameter(in = ParameterIn.DEFAULT, description = "Information of a VNF alarm.", required = true, schema = @Schema()) @Valid @RequestBody AlarmNotification body);
