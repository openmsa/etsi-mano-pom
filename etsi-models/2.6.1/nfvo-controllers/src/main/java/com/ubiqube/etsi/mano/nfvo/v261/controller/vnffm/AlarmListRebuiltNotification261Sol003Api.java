 ...
 *
 */
@RequestMapping("/sol003/vnffm/v1/alarms/notification")
@RolesAllowed({ "ROLE_VNFM" })
public interface AlarmListRebuiltNotification261Sol003Api {
	...
	@RequestMapping(value = "/alarm-list-rebuilt", produces = { "application/json" }, method = RequestMethod.GET)
	ResponseEntity<Void> alarmListRebuiltNotificationCheck();

	@Operation(summary = "", description = "Notify. The POST method notifies a VNF alarm or that the alarm list has been rebuilt. The API consumer shall have previously created an \"Individual subscription resource\" with a matching filter. This method shall follow the provisions specified in the tables 7.4.6.3.1-1 and 7.4.6.3.1-2 for URI query parameters, request and response data structures, and response codes. ", tags = {})
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "500", description = "500 INTERNAL SERVER ERROR If there is an application error not related to the client's input that cannot be easily mapped to any other HTTP response code (\"catch all error\"), the API producer shall respond with this response code. The \"ProblemDetails\" structure shall be provided, and shall include in the \"detail\" attribute more information about the source of the problem. ", content = @Content(schema = @Schema(implementation = ProblemDetails.class))),
			@ApiResponse(responseCode = "503", description = "503 SERVICE UNAVAILABLE If the API producer encounters an internal overload situation of itself or of a system it relies on, it should respond with this response code, following the provisions in IETF RFC 7231 for the use of the \"Retry-After\" HTTP header and for the alternative to refuse the connection. The \"ProblemDetails\" structure may be omitted. ", content = @Content(schema = @Schema(implementation = ProblemDetails.class))) })
	@RequestMapping(value = "/alarm-list-rebuilt", produces = { "application/json" }, consumes = { "application/json" }, method = RequestMethod.POST)
	ResponseEntity<Void> alarmListRebuiltNotificationPost(
			@Parameter(in = ParameterIn.DEFAULT, description = "Information that the alarm list has been rebuilt by the VNFM", required = true, schema = @Schema()) @Valid @RequestBody AlarmListRebuiltNotification body);
