...
public interface AlarmClearedNotification261Sol003Api {
	...
	ResponseEntity<Void> alarmClearedNotificationCheck();
	...
	ResponseEntity<Void> AlarmClearedNotificationPost(
			@Parameter(in = ParameterIn.DEFAULT, description = "Information of the clearance of a VNF alarm", required = true, schema = @Schema()) @Valid @RequestBody AlarmClearedNotification body);
