...
public class VnfLcmSubscriptions261Sol003Controller implements VnfLcmSubscriptions261Sol003Api {
	...
	public ResponseEntity<LccnSubscription> subscriptionsPost(@Valid final LccnSubscriptionRequest body) {
		return frontController.create(body, LccnSubscription.class, VnfLcmSubscriptions261Sol003Api.class, VnfLcmSubscriptions261Sol003Controller::makeLinks, VnfLcmSubscriptions261Sol003Controller::getSelfLink);
	}
	...
	public ResponseEntity<LccnSubscription> subscriptionsSubscriptionIdGet(final String subscriptionId) {
		return frontController.findById(subscriptionId, LccnSubscription.class, VnfLcmSubscriptions261Sol003Controller::makeLinks);
	}
