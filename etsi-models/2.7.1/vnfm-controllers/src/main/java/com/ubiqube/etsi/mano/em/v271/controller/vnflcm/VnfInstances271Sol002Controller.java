...
public class VnfInstances271Sol002Controller implements VnfInstances271Sol002Api {
	...
	public ResponseEntity<Void> vnfInstancesVnfInstanceIdHealPost(final String vnfInstanceId, @Valid final HealVnfRequest body) {
		return frontController.heal(getSafeUUID(vnfInstanceId), body.getCause(), new HashMap<>(), VnfInstances271Sol002Controller::getLcmLink);
	}
	...
	public static String getSelfLink(final String id) {
		return linkTo(methodOn(VnfInstances271Sol002Api.class).vnfInstancesVnfInstanceIdGet(id)).withSelfRel().getHref();
	}
}
