...
// "Version=1.3.0"
@RequestMapping(value = "/sol003/grant/v1/grants", headers = { "Version=1.3.0" })
...
public interface Grants271Sol003Api {
	...
	ResponseEntity<Grant> grantsGrantIdGet(@ApiParam(value = "Identifier of the grant. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request granting a new VNF lifecycle operation. It can also be retrieved from the \"id\" attribute in the payload body of that response. ", required = true) @PathVariable("grantId") final String grantId);
	...
	ResponseEntity<Grant> grantsPost(@ApiParam(value = "", required = true) @Valid @RequestBody final GrantRequest grantRequest);
}
