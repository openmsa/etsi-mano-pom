...
public class Grant {
	 ...
	 * lifecycle management request has originated from the NFVO itself. If this
	 * attribute is present , it need not contain those entries that are unchanged
	 * compared to the entries that were passed in the LCM operation which is
	 * related to this granting exchange. External and/or externally-managed
	 * internal VLs can be passed in VNF lifecycle management operation requests
	 * such as InstantiateVnf or ChangeVnfFlavour, and/or in the grant response. The
