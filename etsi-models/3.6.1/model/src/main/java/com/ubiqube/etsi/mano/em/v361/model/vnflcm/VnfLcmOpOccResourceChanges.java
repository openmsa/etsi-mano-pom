...
public class VnfLcmOpOccResourceChanges   {
  ...
  /**
   * Information about VL instances that were affected during the lifecycle operation. See note 1 and note 3. 
   * @return affectedVirtualLinks
   **/
  @Schema(description = "Information about VL instances that were affected during the lifecycle operation. See note 1 and note 3. ")
      @Valid
