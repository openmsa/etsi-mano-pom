...
import com.ubiqube.etsi.mano.nfvo.v361.model.nslcm.PnfExtCpData;
...
/**
 * This type specifies an PNF to be modified in the NS instance. It shall comply with the provisions defined in Table 6.5.3.15-1. NOTE: At least one attribute shall be present. 
 */
@Schema(description = "This type specifies an PNF to be modified in the NS instance. It shall comply with the provisions defined in Table 6.5.3.15-1. NOTE: At least one attribute shall be present. ")
@Validated
...
public class ModifyPnfData  implements AnyOfModifyPnfData {
   ...
   * @return pnfName
   **/
  @Schema(description = "Name of the PNF. See note. ")
   ...
   * @return cpData
   **/
  @Schema(description = "Address assigned for the PNF external CP(s). See note. ")
      @Valid
