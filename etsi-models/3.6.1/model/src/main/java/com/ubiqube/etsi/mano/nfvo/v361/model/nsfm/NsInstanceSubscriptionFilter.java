 ...
 */
package com.ubiqube.etsi.mano.nfvo.v361.model.nsfm;
...
public class NsInstanceSubscriptionFilter  implements AnyOfNsInstanceSubscriptionFilter {
  ...
  /**
   * If present, match NS instances that were created based on a NSD identified by one of the nsdId values listed in this attribute. See note 1. 
   * @return nsdIds
   **/
  @Schema(description = "If present, match NS instances that were created based on a NSD identified by one of the nsdId values listed in this attribute. See note 1. ")
  ...
  /**
   * If present, match NS instances that contain VNF instances that were created based on a VNFD identified by one of the vnfdId values listed in this attribute. See note 1. 
   * @return vnfdIds
   **/
  @Schema(description = "If present, match NS instances that contain VNF instances that were created based on a VNFD identified by one of the vnfdId values listed in this attribute. See note 1. ")
  ...
  /**
   * If present, match NS instances that contain PNFs that are represented by a PNFD identified by one of the pnfdId values listed in this attribute. See note 1. 
   * @return pnfdIds
   **/
  @Schema(description = "If present, match NS instances that contain PNFs that are represented by a PNFD identified by one of the pnfdId values listed in this attribute. See note 1. ")
  ...
  /**
   * If present, match NS instances with an instance identifier listed in this attribute. See note 2. 
   * @return nsInstanceIds
   **/
  @Schema(description = "If present, match NS instances with an instance identifier listed in this attribute. See note 2. ")
  ...
  /**
   * If present, match NS instances with a NS Instance Name listed in this attribute. See note 2. 
   * @return nsInstanceNames
   **/
  @Schema(description = "If present, match NS instances with a NS Instance Name listed in this attribute. See note 2. ")
