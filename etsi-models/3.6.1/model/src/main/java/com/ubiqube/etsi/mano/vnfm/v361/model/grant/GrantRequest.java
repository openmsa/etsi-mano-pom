...
import com.ubiqube.etsi.mano.vnfm.v361.model.grant.GrantedLcmOperationType;
import java.util.Map;
import com.ubiqube.etsi.mano.vnfm.v361.model.grant.PlacementConstraint;
import com.ubiqube.etsi.mano.vnfm.v361.model.grant.ResourceDefinition;
import com.ubiqube.etsi.mano.vnfm.v361.model.grant.VimConstraint;
...
public class GrantRequest   {
  ...
  /**
   * List of resource definitions in the VNFD for resources to be added by the LCM operation  which is related to this grant request, with one entry per resource. See note 2. 
   * @return addResources
   **/
  ...
  /**
   * Placement constraints that the VNFM may send to the NFVO in order to influence the resource  placement decision. If sent, the NFVO shall take the constraints into consideration when making  resource placement decisions and shall reject the grant if they cannot be honoured. See notes 4,  5 and 6. 
  ...
  public GrantRequest additionalParams(Map<String, String> additionalParams) {
