 ...
 * between the values of one filter attribute). NOTE 1: The permitted values of
 * the \&quot;notificationTypes\&quot; attribute are spelled exactly as the
 * names of the notification types to facilitate automated code generation
 * systems. NOTE 2: The attributes \&quot;vnfProductsFromProviders\&quot;,
 * \&quot;vnfdId\&quot;, and \&quot;vnfPkgId\&quot; are alternatives to
 * reference particular VNF packages in a filter. They should not be used both
...
public class PkgmNotificationsFilter implements OneOfPkgmNotificationsFilter {
	 ...
	 * VnfPackageOnboardingNotification - VnfPackageChangeNotification See note 1.
	 */
	...
	/**
	 * Match VNF packages with a VNFD identifier listed in the attribute. See note
	 * 2.
	 *
	 * @return vnfdId
	 **/
	 ...
	 * \"VnfPackageChangeNotification\", and shall be absent otherwise. See note 2.
	 *
	 * @return vnfPkgId
	 **/
