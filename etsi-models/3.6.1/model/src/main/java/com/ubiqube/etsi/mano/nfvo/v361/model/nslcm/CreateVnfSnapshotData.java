...
public class CreateVnfSnapshotData   {
  ...
  public CreateVnfSnapshotData additionalParams(Map<String, String> additionalParams) {
  ...
  public CreateVnfSnapshotData userDefinedData(Map<String, String> userDefinedData) {
