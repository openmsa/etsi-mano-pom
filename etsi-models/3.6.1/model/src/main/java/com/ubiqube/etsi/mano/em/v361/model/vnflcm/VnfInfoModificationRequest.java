...
public class VnfInfoModificationRequest {
	 ...
	 * The following provisions shall apply when modifying an attribute that is an
	 * array of objects of type \"VnfcInfo\" by supplying an array of objects of
	 * type \"VnfcInfoModifications\". Assumptions: 1) \"oldList\" is the
	 * \"VnfcInfo\" array to be modified and \"newList\" is the
	 * \"VnfcInfoModifications\" array that contains the changes. 2) \"oldEntry\" is
	 * an entry in \"oldList\" and \"newEntry\" is an entry in \"newList\". 3) A
	 * \"newEntry\" has a \"corresponding entry\" if there exists an \"oldEntry\"
	 * that has the same content of the \"id\" attribute as the \"newEntry\"; a
	 * \"newEntry\" has no corresponding entry if no such \"oldEntry\" exists. 4) In
	 * any array of \"VnfcInfo\" resp. \"VnfcInfoModifications\" structures, the
	 * content of \"id\" is unique (i.e. there are no two entries with the same
	 * content of \"id\"). Provisions: 1) For each \"newEntry\" in \"newList\" that
	 * has no corresponding entry in \"oldList\", the \"oldList\" array shall be
	 * modified by adding that \"newEntry\". 2) For each \"newEntry\" in \"newList\"
	 * that has a corresponding \"oldEntry\" in \"oldList\", the value of
	 * \"oldEntry\" shall be updated with the content of \"newEntry\" as specified
	 * for the data type of \"newEntry (refer to clause 5.5.3.24 for the data type
