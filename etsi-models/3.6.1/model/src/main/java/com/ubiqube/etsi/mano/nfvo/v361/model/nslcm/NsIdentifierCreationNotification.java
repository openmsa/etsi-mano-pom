...
public class NsIdentifierCreationNotification {
	...
	public NsIdentifierCreationNotification id(final String id) {
		this.id = id;
		return this;
	}
	...
	public NsIdentifierCreationNotification notificationType(final String notificationType) {
	...
	public NsIdentifierCreationNotification subscriptionId(final String subscriptionId) {
	...
	public NsIdentifierCreationNotification timestamp(final OffsetDateTime timestamp) {
	...
	public NsIdentifierCreationNotification nsInstanceId(final String nsInstanceId) {
	...
	public NsIdentifierCreationNotification _links(final LccnLinks _links) {
		this._links = _links;
		return this;
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		final NsIdentifierCreationNotification nsIdentifierCreationNotification = (NsIdentifierCreationNotification) o;
