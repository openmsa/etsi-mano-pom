 ...
 * crossed. It shall comply with the provisions defined in table 6.5.2.4-1.
 * NOTE: The timing of sending this notification is determined by the capability
 * of the producing entity to evaluate the threshold crossing condition. The
 * notification shall be triggered by the VNFM when a threshold has been
