...
import com.ubiqube.etsi.mano.em.v361.model.vnflcm.LcmOperationStateType;
import com.ubiqube.etsi.mano.em.v361.model.vnflcm.LcmOperationType;
import com.ubiqube.etsi.mano.em.v361.model.vnflcm.VnfInstanceSubscriptionFilter;
...
public class LifecycleChangeNotificationsFilter   {
  ...
  /**
   * Match particular notification types.  Permitted values: - VnfLcmOperationOccurrenceNotification - VnfIdentifierCreationNotification - VnfIdentifierDeletionNotification See note. 
   * @return notificationTypes
   **/
  @Schema(description = "Match particular notification types.  Permitted values: - VnfLcmOperationOccurrenceNotification - VnfIdentifierCreationNotification - VnfIdentifierDeletionNotification See note. ")
