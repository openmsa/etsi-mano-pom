...
@RequestMapping(value = "/sol005/nsd/v2", headers = { "Version=2.2.1" })
@RolesAllowed({ "ROLE_OSSBSS" })
public interface NsdSubscriptions361Sol005Api {

	Logger log = LoggerFactory.getLogger(NsdSubscriptions361Sol005Api.class);
	...
	@Operation(summary = "", description = "The GET method queries the list of active subscriptions of the functional block that invokes the method. It can be used e.g. for resynchronization after error situations. See clause 5.4.8.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK  Shall be returned when the list of subscriptions has been queried successfully. The response body shall contain in an array the representations of all active subscriptions of the functional block that invokes the method, i.e. zero or more representations of NSD management subscriptions as defined in clause 5.5.2.8. If the \"filter\" URI parameter was supplied in the request, the data in the response body shall have been transformed according to the rules specified in clause 5.2.2 of ETSI GS NFV-SOL 013. If the NFVO supports alternative 2 (paging) according to clause 5.4.2.1 of ETSI GS NFV SOL 013 for this resource, inclusion of the Link HTTP header in this response shall follow the provisions in clause 5.4.2.3 of ETSI GS NFV SOL 013. ", content = @Content(array = @ArraySchema(schema = @Schema(implementation = NsdmSubscription.class)))),
	...
	@Operation(summary = "", description = "The POST method creates a new subscription. See clause 5.4.8.3.1. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "201 CREATED  Shall be returned when the subscription has been created successfully. A representation of the created \"Individual subscription\" resource shall be returned in the response body, as defined in clause 5.5.2.8. The HTTP response shall include a \"Location:\" HTTP header that points to the created \"Individual subscription\" resource. ", content = @Content(schema = @Schema(implementation = NsdmSubscription.class))),
			...
			@ApiResponse(responseCode = "422", description = "422 Unprocessable Entity  Shall be returned upon the following error: The content type of the payload body is supported and the payload body of a request contains syntactically correct data but the data cannot be processed. The general cause for this error and its handling is specified in clause 6.4 of ETSI GS NFV-SOL 013 [16], including rules for the presence of the response body. Specifically in case of this resource, the response code 422 shall also be returned if the NFVO has tested the Notification endpoint as described in clause 5.4.10.3.2 and the test has failed. In this case, the \"detail\" attribute in the \"ProblemDetails\" structure shall convey more information about the error. ", content = @Content(schema = @Schema(implementation = ProblemDetails.class))),
	...
	default ResponseEntity<NsdmSubscription> subscriptionsPost(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true, schema = @Schema()) @RequestHeader(value = "Content-Type", required = true) final String contentType, @Parameter(in = ParameterIn.DEFAULT, description = "Details of the subscription to be created, as defined in clause 5.5.2.7.", required = true, schema = @Schema()) @Valid @RequestBody final NsdmSubscriptionRequest body,
	...
	@Operation(summary = "", description = "The DELETE method terminates an individual subscription. See clause 5.4.9.3.5. ", tags = {})
	@ApiResponses(value = {
	...
	@Operation(summary = "", description = "The GET method retrieves information about a subscription by reading an individual subscription resource. See clause 5.4.9.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK  Shall be returned when information about an individual subscription has been read successfully. The response body shall contain a representation of the subscription resource. ", content = @Content(schema = @Schema(implementation = NsdmSubscription.class))),
