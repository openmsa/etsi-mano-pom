...
@RequestMapping(value = "/sol005/nsfm/v1", headers = { "Version=1.2.0" })
@RolesAllowed({ "ROLE_OSSBSS" })
public interface AlarmsSubscriptions361Sol005Api {

	Logger log = LoggerFactory.getLogger(AlarmsSubscriptions361Sol005Api.class);
	...
	@Operation(summary = "", description = "The API consumer can use this method to retrieve the list of active subscriptions for alarms related to an NS subscribed by the API consumer. It can be used e.g. for resynchronization after error situations. See clause 8.4.4.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when the list of subscriptions has been queried successfully. The response body shall contain in an array the representations of all active subscriptions of the functional block that invokes the method, i.e. zero or more representations of FM subscriptions, as defined in clause 8.5.2.3. If the \"filter\" URI parameter was supplied in the request, the data in the response body shall have been transformed according to the rules specified in clause 5.2.2 of ETSI GS NFV-SOL 013 [16]. If the NFVO supports alternative 2 (paging) according to clause 5.4.2.1 of ETSI GS NFV-SOL 013 [16] for this resource, inclusion of the Link HTTP header in this response shall follow the provisions in clause 5.4.2.3 of ETSI GS NFV-SOL 013 [16]. ", content = @Content(array = @ArraySchema(schema = @Schema(implementation = FmSubscription.class)))),
	...
	default ResponseEntity<List<FmSubscription>> subscriptionsGet(
			...
			@Parameter(in = ParameterIn.QUERY, description = "Attribute-based filtering expression according to clause 5.2 of ETSI GS NFV SOL 013. The NFVO shall support receiving this parameter as part of the URI query string.  The OSS/BSS may supply this parameter. All attribute names that appear in the FmSubscription and in data types referenced from  it shall be supported by the NFVO in the filter expression. ", schema = @Schema()) @Valid @RequestParam(value = "filter", required = false) final String filter,
			...
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue(
							"[ {\n  \"filter\" : {\n    \"perceivedSeverities\" : [ \"CRITICAL\", \"CRITICAL\" ],\n    \"nsInstanceSubscriptionFilter\" : {\n      \"nsdIds\" : [ null, null ],\n      \"vnfdIds\" : [ null, null ],\n      \"pnfdIds\" : [ null, null ],\n      \"nsInstanceIds\" : [ null, null ],\n      \"nsInstanceNames\" : [ \"nsInstanceNames\", \"nsInstanceNames\" ]\n    },\n    \"faultyResourceTypes\" : [ \"COMPUTE\", \"COMPUTE\" ],\n    \"probableCauses\" : [ \"probableCauses\", \"probableCauses\" ],\n    \"notificationTypes\" : [ \"AlarmNotification\", \"AlarmNotification\" ],\n    \"eventTypes\" : [ \"COMMUNICATIONS_ALARM\", \"COMMUNICATIONS_ALARM\" ]\n  },\n  \"_links\" : {\n    \"self\" : {\n      \"href\" : \"http://example.com/aeiou\"\n    }\n  },\n  \"callbackUri\" : \"http://example.com/aeiou\",\n  \"id\" : \"id\"\n}, {\n  \"filter\" : {\n    \"perceivedSeverities\" : [ \"CRITICAL\", \"CRITICAL\" ],\n    \"nsInstanceSubscriptionFilter\" : {\n      \"nsdIds\" : [ null, null ],\n      \"vnfdIds\" : [ null, null ],\n      \"pnfdIds\" : [ null, null ],\n      \"nsInstanceIds\" : [ null, null ],\n      \"nsInstanceNames\" : [ \"nsInstanceNames\", \"nsInstanceNames\" ]\n    },\n    \"faultyResourceTypes\" : [ \"COMPUTE\", \"COMPUTE\" ],\n    \"probableCauses\" : [ \"probableCauses\", \"probableCauses\" ],\n    \"notificationTypes\" : [ \"AlarmNotification\", \"AlarmNotification\" ],\n    \"eventTypes\" : [ \"COMMUNICATIONS_ALARM\", \"COMMUNICATIONS_ALARM\" ]\n  },\n  \"_links\" : {\n    \"self\" : {\n      \"href\" : \"http://example.com/aeiou\"\n    }\n  },\n  \"callbackUri\" : \"http://example.com/aeiou\",\n  \"id\" : \"id\"\n} ]",
	...
	@Operation(summary = "", description = "The POST method creates a new subscription. See clause 8.4.4.3.1. ", tags = {})
	@ApiResponses(value = {
	...
	default ResponseEntity<FmSubscription> subscriptionsPost(
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			...
			@Parameter(in = ParameterIn.DEFAULT, description = "Details of the subscription to be created, as defined in clause 8.5.2.2.", required = true, schema = @Schema()) @Valid @RequestBody final FmSubscriptionRequest body,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"filter\" : {\n    \"perceivedSeverities\" : [ \"CRITICAL\", \"CRITICAL\" ],\n    \"nsInstanceSubscriptionFilter\" : {\n      \"nsdIds\" : [ null, null ],\n      \"vnfdIds\" : [ null, null ],\n      \"pnfdIds\" : [ null, null ],\n      \"nsInstanceIds\" : [ null, null ],\n      \"nsInstanceNames\" : [ \"nsInstanceNames\", \"nsInstanceNames\" ]\n    },\n    \"faultyResourceTypes\" : [ \"COMPUTE\", \"COMPUTE\" ],\n    \"probableCauses\" : [ \"probableCauses\", \"probableCauses\" ],\n    \"notificationTypes\" : [ \"AlarmNotification\", \"AlarmNotification\" ],\n    \"eventTypes\" : [ \"COMMUNICATIONS_ALARM\", \"COMMUNICATIONS_ALARM\" ]\n  },\n  \"_links\" : {\n    \"self\" : {\n      \"href\" : \"http://example.com/aeiou\"\n    }\n  },\n  \"callbackUri\" : \"http://example.com/aeiou\",\n  \"id\" : \"id\"\n}", FmSubscription.class), HttpStatus.NOT_IMPLEMENTED);
				} catch (final IOException e) {
					log.error("Couldn't serialize response for content type application/json", e);
					return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
				}
	...
	@Operation(summary = "", description = "This method terminates an individual subscription. See clause 8.4.5.3.5. ", tags = {})
	@ApiResponses(value = {
	...
	@Operation(summary = "", description = "The API consumer can use this method for reading an individual subscription for alarms related to NSs subscribed by the API consumer. See clause 8.4.5.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when information about an individual subscription has been read successfully. The response body shall contain a representation of the subscription resource. ", content = @Content(schema = @Schema(implementation = FmSubscription.class))),
	...
	default ResponseEntity<FmSubscription> subscriptionsSubscriptionIdGet(
			@Parameter(in = ParameterIn.PATH, description = "Identifier of this subscription. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new subscription resource. It can also be retrieved from the \"id\" attribute in the payload body of that response. ", required = true, schema = @Schema()) @PathVariable("subscriptionId") final String subscriptionId,
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
