...
public interface NsLcmSubscriptions361Sol005Api {
	...
	Logger log = LoggerFactory.getLogger(NsLcmSubscriptions361Sol005Api.class);
	...
	@Operation(summary = "", description = "The GET method queries the list of active subscriptions of the functional block that invokes the method. It can be used e.g. for resynchronization after error situations. See clause 6.4.16.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when the list of subscriptions has been queried successfully. The response body shall contain in an array the representations of all active subscriptions of the functional block that invokes the method, i.e. zero or more representations of lifecycle change notification subscriptions as defined in clause 6.5.2.4. If the \"filter\" URI parameter was supplied in the request, the data in the response body shall have been transformed according to the rules specified in clause 5.2.2 of ETSI GS NFV-SOL 013 [16]. If the NFVO supports alternative 2 (paging) according to clause 5.4.2.1 of ETSI GS NFV-SOL 013 [16] for this resource, inclusion of the Link HTTP header in this response shall follow the provisions in clause 5.4.2.3 of ETSI GS NFV-SOL 013 [16]. ", content = @Content(array = @ArraySchema(schema = @Schema(implementation = LccnSubscription.class)))),
	...
	default ResponseEntity<List<LccnSubscription>> subscriptionsGet(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization,
			@Parameter(in = ParameterIn.QUERY, description = "Attribute-based filtering expression according to clause 5.2 of ETSI GS NFV SOL 013. The NFVO shall support receiving this parameter as part of the URI query string.  The OSS/BSS may supply this parameter. All attribute names that appear in the LccnSubscription and in data types referenced  from it shall be supported by the NFVO in the filter expression. ", schema = @Schema()) @Valid @RequestParam(value = "filter", required = false) final String filter, @Parameter(in = ParameterIn.QUERY, description = "Marker to obtain the next page of a paged response. Shall be supported by the NFVO if the NFVO supports alternative 2  (paging) according to clause 5.4.2.1 of ETSI GS NFV-SOL 013 for this resource. ", schema = @Schema()) @Valid @RequestParam(value = "nextpage_opaque_marker", required = false) final String nextpageOpaqueMarker) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue(
							"[ {\n  \"filter\" : {\n    \"lcmOpOccStatusImpactingNsComponent\" : [ \"VNF_INSTANTIATE\", \"VNF_INSTANTIATE\" ],\n    \"operationStates\" : [ \"PROCESSING\", \"PROCESSING\" ],\n    \"nsInstanceSubscriptionFilter\" : {\n      \"nsdIds\" : [ null, null ],\n      \"vnfdIds\" : [ null, null ],\n      \"pnfdIds\" : [ null, null ],\n      \"nsInstanceIds\" : [ null, null ],\n      \"nsInstanceNames\" : [ \"nsInstanceNames\", \"nsInstanceNames\" ]\n    },\n    \"nsComponentTypes\" : [ \"VNF\", \"VNF\" ],\n    \"notificationTypes\" : [ \"NsLcmOperationOccurenceNotification\", \"NsLcmOperationOccurenceNotification\" ],\n    \"affectedNsInstanceIds\" : [ null, null ],\n    \"lcmOpNameImpactingNsComponent\" : [ \"VNF_INSTANTIATE\", \"VNF_INSTANTIATE\" ],\n    \"operationTypes\" : [ \"INSTANTIATE\", \"INSTANTIATE\" ]\n  },\n  \"_links\" : {\n    \"self\" : {\n      \"href\" : \"http://example.com/aeiou\"\n    }\n  },\n  \"callbackUri\" : \"http://example.com/aeiou\",\n  \"id\" : \"id\",\n  \"verbosity\" : \"FULL\"\n}, {\n  \"filter\" : {\n    \"lcmOpOccStatusImpactingNsComponent\" : [ \"VNF_INSTANTIATE\", \"VNF_INSTANTIATE\" ],\n    \"operationStates\" : [ \"PROCESSING\", \"PROCESSING\" ],\n    \"nsInstanceSubscriptionFilter\" : {\n      \"nsdIds\" : [ null, null ],\n      \"vnfdIds\" : [ null, null ],\n      \"pnfdIds\" : [ null, null ],\n      \"nsInstanceIds\" : [ null, null ],\n      \"nsInstanceNames\" : [ \"nsInstanceNames\", \"nsInstanceNames\" ]\n    },\n    \"nsComponentTypes\" : [ \"VNF\", \"VNF\" ],\n    \"notificationTypes\" : [ \"NsLcmOperationOccurenceNotification\", \"NsLcmOperationOccurenceNotification\" ],\n    \"affectedNsInstanceIds\" : [ null, null ],\n    \"lcmOpNameImpactingNsComponent\" : [ \"VNF_INSTANTIATE\", \"VNF_INSTANTIATE\" ],\n    \"operationTypes\" : [ \"INSTANTIATE\", \"INSTANTIATE\" ]\n  },\n  \"_links\" : {\n    \"self\" : {\n      \"href\" : \"http://example.com/aeiou\"\n    }\n  },\n  \"callbackUri\" : \"http://example.com/aeiou\",\n  \"id\" : \"id\",\n  \"verbosity\" : \"FULL\"\n} ]",
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "422", description = "422 Unprocessable Entity  Shall be returned upon the following error: The content type of the payload body is supported and the payload body of a request contains syntactically correct data but the data cannot be processed. The general cause for this error and its handling is specified in clause 6.4 of ETSI GS NFV-SOL 013 [16], including rules for the presence of the response body. Specifically in case of this resource, the response code 422 shall also be returned if the NFVO has tested the Notification endpoint as described in clause 6.4.18.3.2 and the test has failed. In this case, the \"detail\" attribute in the \"ProblemDetails\" structure shall convey more information about the error. ", content = @Content(schema = @Schema(implementation = ProblemDetails.class))),
	...
	default ResponseEntity<LccnSubscription> subscriptionsPost(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true, schema = @Schema()) @RequestHeader(value = "Content-Type", required = true) final String contentType, @Parameter(in = ParameterIn.DEFAULT, description = "Details of the subscription to be created, as defined in clause 6.5.2.2.", required = true, schema = @Schema()) @Valid @RequestBody final LccnSubscriptionRequest body,
	...
	@Operation(summary = "", description = "The DELETE method terminates an individual subscription. See clause 6.4.17.3.5. ", tags = {})
	@ApiResponses(value = {
	...
	@Operation(summary = "", description = "The GET method retrieves information about a subscription by reading an \"Individual subscription\" resource. See clause 6.4.17.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when information about an individual subscription has been read successfully. The response body shall contain a representation of the \"Individual subscription\" resource. ", content = @Content(schema = @Schema(implementation = LccnSubscription.class))),
	...
	default ResponseEntity<LccnSubscription> subscriptionsSubscriptionIdGet(@Parameter(in = ParameterIn.PATH, description = "Identifier of this subscription. ", required = true, schema = @Schema()) @PathVariable("subscriptionId") final String subscriptionId, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"filter\" : {\n    \"lcmOpOccStatusImpactingNsComponent\" : [ \"VNF_INSTANTIATE\", \"VNF_INSTANTIATE\" ],\n    \"operationStates\" : [ \"PROCESSING\", \"PROCESSING\" ],\n    \"nsInstanceSubscriptionFilter\" : {\n      \"nsdIds\" : [ null, null ],\n      \"vnfdIds\" : [ null, null ],\n      \"pnfdIds\" : [ null, null ],\n      \"nsInstanceIds\" : [ null, null ],\n      \"nsInstanceNames\" : [ \"nsInstanceNames\", \"nsInstanceNames\" ]\n    },\n    \"nsComponentTypes\" : [ \"VNF\", \"VNF\" ],\n    \"notificationTypes\" : [ \"NsLcmOperationOccurenceNotification\", \"NsLcmOperationOccurenceNotification\" ],\n    \"affectedNsInstanceIds\" : [ null, null ],\n    \"lcmOpNameImpactingNsComponent\" : [ \"VNF_INSTANTIATE\", \"VNF_INSTANTIATE\" ],\n    \"operationTypes\" : [ \"INSTANTIATE\", \"INSTANTIATE\" ]\n  },\n  \"_links\" : {\n    \"self\" : {\n      \"href\" : \"http://example.com/aeiou\"\n    }\n  },\n  \"callbackUri\" : \"http://example.com/aeiou\",\n  \"id\" : \"id\",\n  \"verbosity\" : \"FULL\"\n}", LccnSubscription.class), HttpStatus.NOT_IMPLEMENTED);
