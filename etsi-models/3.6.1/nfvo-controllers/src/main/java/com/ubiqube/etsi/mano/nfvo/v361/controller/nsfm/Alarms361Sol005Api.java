...
public interface Alarms361Sol005Api {

	Logger log = LoggerFactory.getLogger(Alarms361Sol005Api.class);
	...
	@Operation(summary = "", description = "The API consumer can use this method to read an individual alarm. See clause 8.4.3.3.2. ", tags = {})
	@ApiResponses(value = {
	...
	default ResponseEntity<Alarm> alarmsAlarmIdGet(
	...
	@Operation(summary = "", description = "This method modifies an individual alarm resource. See clause 8.4.3.3.4. ", tags = {})
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "409", description = "409 CONFLICT Shall be returned upon the following error: The operation cannot be executed currently, due to a conflict with the state of the \"Individual alarm\" resource. Typically, this is due to the fact that the alarm is already in the state that is requested to be set (such as trying to acknowledge an already-acknowledged alarm). The response body shall contain a ProblemDetails structure, in which the \"detail\" attribute shall convey more information about the error. ", content = @Content(schema = @Schema(implementation = ProblemDetails.class))),
	...
	default ResponseEntity<AlarmModifications> alarmsAlarmIdPatch(
			@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
			@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			...
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the alarm. This identifier can be retrieved from the \"id\" attribute of the \"alarm\" attribute in the AlarmNotification or AlarmClearedNotification.  It can also be retrieved from the \"id\" attribute of the applicable array element in the payload body of the response to a GET request to the \"Alarms\" resource. ", required = true, schema = @Schema()) @PathVariable("alarmId") final String alarmId,
			@Parameter(in = ParameterIn.DEFAULT, description = "The parameter for the alarm modification, as defined in clause 8.5.2.8.", required = true, schema = @Schema()) @Valid @RequestBody final AlarmModifications body,
			@Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
	...
	@Operation(summary = "", description = "The API consumer can use this method to retrieve information about the alarm list. See clause 8.4.2.3.2. ", tags = {})
	@ApiResponses(value = {
