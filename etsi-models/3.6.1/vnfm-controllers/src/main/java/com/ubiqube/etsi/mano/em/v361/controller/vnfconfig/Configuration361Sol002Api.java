...
@Validated
public interface Configuration361Sol002Api {

	Logger log = LoggerFactory.getLogger(Configuration361Sol002Api.class);
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when configuration information about a VNF instance  has been read successfully. The response body shall contain a representation of the configuration resource. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = VnfConfiguration.class))),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when the request has been accepted and completed.  The response body shall contain the parameters of the configuration  modification that was applied to the configuration resource. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = VnfConfigModifications.class))),
