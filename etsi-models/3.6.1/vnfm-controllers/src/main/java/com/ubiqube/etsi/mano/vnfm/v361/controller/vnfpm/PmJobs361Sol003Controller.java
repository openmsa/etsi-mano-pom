...
import com.ubiqube.etsi.mano.em.v361.model.vnfpm.PerformanceReport;
import com.ubiqube.etsi.mano.em.v361.model.vnfpm.PmJob;
import com.ubiqube.etsi.mano.em.v361.model.vnfpm.PmJobLinks;
import com.ubiqube.etsi.mano.em.v361.model.vnfpm.PmJobModifications;
...
public class PmJobs361Sol003Controller implements PmJobs361Sol003Api {
	...
	public PmJobs361Sol003Controller(final VnfmPmGenericFrontController vnfmPmGenericFrontController) {
	...
	public ResponseEntity<String> pmJobsGet(final MultiValueMap<String, String> requestParams, final String nextpageOpaqueMarker) {
		return vnfmPmGenericFrontController.search(requestParams, PmJob.class, PmJobs361Sol003Controller::makeLinks);
	}

	private static void makeLinks(final PmJob x) {
		final PmJobLinks links = new PmJobLinks();
		Link link = new Link();
		link.setHref(linkTo(methodOn(PmJobs361Sol003Api.class).pmJobsPmJobIdGet(x.getId())).withSelfRel().getHref());
		links.setSelf(link);
	...
	private static String makeSelf(final PmJob pmjob) {
		return linkTo(methodOn(PmJobs361Sol003Api.class).pmJobsPmJobIdGet(pmjob.getId())).withSelfRel().getHref();
	}
	...
	public ResponseEntity<PmJob> pmJobsPmJobIdGet(final String pmJobIdn) {
		return vnfmPmGenericFrontController.findById(UUID.fromString(pmJobIdn), PmJob.class, PmJobs361Sol003Controller::makeLinks);
	}
	...
	public ResponseEntity<PmJob> pmJobsPost(@Valid final CreatePmJobRequest createPmJobRequest) {
		return vnfmPmGenericFrontController.pmJobsPost(createPmJobRequest, PmJob.class, PmJobs361Sol003Controller::makeLinks, PmJobs361Sol003Controller::makeSelf);
	}
