...
public class PmJobs361Sol002Controller implements PmJobs361Sol002Api {
	...
	public PmJobs361Sol002Controller(final VnfmPmGenericFrontController vnfmPmGenericFrontController) {
	...
	public ResponseEntity<String> pmJobsGet(final MultiValueMap<String, String> requestParams, final String nextpageOpaqueMarker) {
		return vnfmPmGenericFrontController.search(requestParams, PmJob.class, PmJobs361Sol002Controller::makeLinks);
	}

	private static void makeLinks(final PmJob x) {
		final PmJobLinks links = new PmJobLinks();
		Link link = new Link();
		link.setHref(linkTo(methodOn(PmJobs361Sol002Api.class).pmJobsPmJobIdGet(x.getId())).withSelfRel().getHref());
		links.setSelf(link);
	...
	private static String makeSelf(final PmJob pmjob) {
		return linkTo(methodOn(PmJobs361Sol002Api.class).pmJobsPmJobIdGet(pmjob.getId())).withSelfRel().getHref();
	}
	...
	public ResponseEntity<PmJob> pmJobsPmJobIdGet(final String pmJobId) {
		return vnfmPmGenericFrontController.findById(UUID.fromString(pmJobId), PmJob.class, PmJobs361Sol002Controller::makeLinks);
	}
	...
	public ResponseEntity<PmJob> pmJobsPost(@Valid final CreatePmJobRequest createPmJobRequest) {
		return vnfmPmGenericFrontController.pmJobsPost(createPmJobRequest, PmJob.class, PmJobs361Sol002Controller::makeLinks, PmJobs361Sol002Controller::makeSelf);
	}
