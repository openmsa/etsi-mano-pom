...
@Validated
public interface IndicatorsAlarms361Sol002Api {

	Logger log = LoggerFactory.getLogger(IndicatorsAlarms361Sol002Api.class);
	...
	default ResponseEntity<List<VnfIndicator>> indicatorsVnfInstanceIdGet(@Parameter(in = ParameterIn.PATH, description = "Service Unavailable. Identifier of the VNF instance to which the VNF indicators applies. NOTE: This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new VNF instance resource. It can also be retrieved from the \"id\" attribute in the payload body of that response. ", required = true, schema = @Schema()) @PathVariable("vnfInstanceId") final String vnfInstanceId, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization,
	...
	default ResponseEntity<VnfIndicator> indicatorsVnfInstanceIdIndicatorIdGet(@Parameter(in = ParameterIn.PATH, description = "Service Unavailable. Identifier of the VNF instance to which the VNF indicators applies. NOTE: This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new VNF instance resource. It can also be retrieved from the \"id\" attribute in the payload body of that response. ", required = true, schema = @Schema()) @PathVariable("vnfInstanceId") final String vnfInstanceId, @Parameter(in = ParameterIn.PATH, description = "Identifier of the VNF indicator. ", required = true, schema = @Schema()) @PathVariable("indicatorId") final String indicatorId, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
