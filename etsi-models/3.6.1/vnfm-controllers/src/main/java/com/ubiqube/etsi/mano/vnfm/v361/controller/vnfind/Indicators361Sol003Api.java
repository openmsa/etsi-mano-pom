...
public interface Indicators361Sol003Api {

	Logger log = LoggerFactory.getLogger(Indicators361Sol003Api.class);
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "403", description = "403 FORBIDDEN If the API consumer is not allowed to perform a particular request to a particular resource, the API producer shall respond with this response code. The \"ProblemDetails\" structure shall be provided. It should include in the \"detail\" attribute information about the source of the problem, and may indicate how to solve it. ", content = @Content(schema = @Schema(implementation = ProblemDetails2.class))),
	...
	@Operation(summary = "", description = "The DELETE method terminates an individual subscription. See clause 8.4.6.3.5. ", tags = {})
	@ApiResponses(value = {
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "504", description = "504 GATEWAY TIMEOUT If the API producer encounters a timeout while waiting for a response from an upstream server (i.e. a server that the API producer communicates with when fulfilling a request), it should respond with this response code. ", content = @Content(schema = @Schema(implementation = ProblemDetails2.class))) })
	@RequestMapping(value = "/indicators/subscriptions/{subscriptionId}", produces = { "application/json" }, method = RequestMethod.GET)
	default ResponseEntity<VnfIndicatorSubscription> indicatorsSubscriptionsSubscriptionIdGet(@Parameter(in = ParameterIn.PATH, description = "Identifier of this subscription. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new \"Individual subscription\" resource. It can also be retrieved from the \"id\" attribute in the payload body of that response. ", required = true, schema = @Schema()) @PathVariable("subscriptionId") final String subscriptionId, @Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true, schema = @Schema()) @RequestHeader(value = "Content-Type", required = true) final String contentType, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version,
	...
	default ResponseEntity<List<VnfIndicator>> indicatorsVnfInstanceIdGet(@Parameter(in = ParameterIn.PATH, description = "Identifier of the VNF instance to which the VNF indicator applies. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new \"Individual VNF instance\" resource. It can also be retrieved from the \"id\" attribute in the payload body of that response. ", required = true, schema = @Schema()) @PathVariable("vnfInstanceId") final String vnfInstanceId, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true, schema = @Schema()) @RequestHeader(value = "Content-Type", required = true) final String contentType,
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when the VNF indicator has been read successfully. The response body shall contain the representation of the VNF indicator. ", content = @Content(schema = @Schema(implementation = VnfIndicator.class))),
	...
	default ResponseEntity<VnfIndicator> indicatorsVnfInstanceIdIndicatorIdGet(@Parameter(in = ParameterIn.PATH, description = "Identifier of the VNF indicator. This identifier can be retrieved from the resource referenced by the payload body in the response to a POST request creating a new \"Individual VNF instance\" resource. ", required = true, schema = @Schema()) @PathVariable("indicatorId") final String indicatorId, @Parameter(in = ParameterIn.PATH, description = "Identifier of the VNF instance to which the VNF indicator applies. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new \"Individual VNF instance\" resource. It can also be retrieved from the \"id\" attribute in the payload body of that response. ", required = true, schema = @Schema()) @PathVariable("vnfInstanceId") final String vnfInstanceId, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept,
			@Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true, schema = @Schema()) @RequestHeader(value = "Content-Type", required = true) final String contentType, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"vnfInstanceId\" : \"vnfInstanceId\",\n  \"_links\" : {\n    \"self\" : {\n      \"href\" : \"href\"\n    }\n  },\n  \"name\" : \"name\",\n  \"id\" : \"id\",\n  \"value\" : { }\n}", VnfIndicator.class), HttpStatus.NOT_IMPLEMENTED);
				} catch (final IOException e) {
					log.error("Couldn't serialize response for content type application/json", e);
					return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
				}
