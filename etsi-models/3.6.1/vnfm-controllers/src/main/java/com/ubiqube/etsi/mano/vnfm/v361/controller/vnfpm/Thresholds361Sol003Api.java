...
public interface Thresholds361Sol003Api {

	Logger log = LoggerFactory.getLogger(Thresholds361Sol003Api.class);
	...
	@Operation(summary = "", description = "The API consumer can use this method to query information about thresholds. See clause 6.4.5.3.2. ", tags = {})
	@ApiResponses(value = {
	...
	@Operation(summary = "", description = "The POST method can be used by the API consumer to create a threshold. See clause 6.4.5.3.1. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "201 CREATED  Shall be returned when a threshold has been created successfully. The response body shall contain a representation of the created \"Individual threshold\" resource, as defined in clause 6.5.2.9. The HTTP response shall include a \"Location\" HTTP header that contains the resource URI of the created threshold resource. ", content = @Content(schema = @Schema(implementation = Threshold.class))),
			...
			@ApiResponse(responseCode = "422", description = "422 Unprocessable Entity  Shall be returned upon the following error: The content type of the payload body is supported and the payload body of a request contains syntactically correct data but the data cannot be processed. The general cause for this error and its handling is specified in clause 6.4 of ETSI GS NFV-SOL 013 [8], including rules for the presence of the response body. Specifically in case of this resource, the response code 422 shall also be returned if the VNFM has tested the Notification endpoint as described in clause 6.4.9.3.2 and the test has failed. In this case, the \"detail\" attribute in the \"ProblemDetails\" structure shall convey more information about the error ", content = @Content(schema = @Schema(implementation = ProblemDetails2.class))),
	...
	@Operation(summary = "", description = "This method allows to delete a threshold. See clause 6.4.6.3.5. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "204", description = "204 NO CONTENT  The threshold was deleted successfully. The response body shall be empty. "),
	...
	@Operation(summary = "", description = "The API consumer can use this method for reading an individual threshold. See clause 6.4.6.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK  Shall be returned when information about an individual threshold has been read successfully. The response body shall contain a representation of the threshold, as defined in clause 6.5.2.9. ", content = @Content(schema = @Schema(implementation = Threshold.class))),
	...
	@Operation(summary = "", description = "This method allows to modify an \"Individual threshold\" resource. See clause 6.4.6.3.4. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK  Shall be returned when the request has been processed successfully. The response body shall contain a data structure of type \"ThresholdModifications\". ", content = @Content(schema = @Schema(implementation = ThresholdModifications.class))),
