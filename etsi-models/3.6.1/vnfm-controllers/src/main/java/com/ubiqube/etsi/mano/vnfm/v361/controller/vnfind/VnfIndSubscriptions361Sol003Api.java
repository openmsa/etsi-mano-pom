...
public interface VnfIndSubscriptions361Sol003Api {

	Logger log = LoggerFactory.getLogger(VnfIndSubscriptions361Sol003Api.class);
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK  Shall be returned when the list of subscriptions has been queried successfully. The response body shall contain in an array the representations of all active subscriptions of the functional block that invokes the method which match the attribute filter, i.e. zero or more representations of VNF indicator subscriptions as defined in clause 8.5.2.4. If the \"filter\" URI parameter was supplied in the request, the data in the response body shall have been transformed according to the rules specified in clause 5.2.2 of ETSI GS NFV-SOL 013. If the VNFM supports alternative 2 (paging) according to clause 5.4.2.1 of ETSI GS NFV-SOL 013 for this resource, inclusion of the Link HTTP header in this response shall follow the provisions in clause 5.4.2.3 of ETSI GS NFV-SOL 013. ", content = @Content(array = @ArraySchema(schema = @Schema(implementation = VnfIndicatorSubscription.class)))),
	...
	@Operation(summary = "", description = "The POST method creates a new subscription. See clause 8.4.5.3.1. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "201 CREATED  Shall be returned when the subscription has been created successfully. The response body shall contain a representation of the created \"Individual subscription\" resource. The HTTP response shall include a \"Location\" HTTP header that points to the created resource. ", content = @Content(array = @ArraySchema(schema = @Schema(implementation = VnfIndicatorSubscription.class)))),
			...
			@ApiResponse(responseCode = "422", description = "422 Unprocessable Entity  Shall be returned when a subscription with the same callback URI and the same filter already exists and the policy of the VNFM is to not create redundant subscriptions. The HTTP response shall include a \"Location\" HTTP header that contains the resource URI of the existing \"Individual subscription\" resource. The response body shall be empty ", content = @Content(schema = @Schema(implementation = ProblemDetails2.class))),
	...
	default ResponseEntity<List<VnfIndicatorSubscription>> subscriptionsPost(@Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true, schema = @Schema()) @RequestHeader(value = "Content-Type", required = true) final String contentType, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.DEFAULT, description = "Details of the subscription to be created.", required = true, schema = @Schema()) @Valid @RequestBody final VnfIndicatorSubscriptionRequest body,
