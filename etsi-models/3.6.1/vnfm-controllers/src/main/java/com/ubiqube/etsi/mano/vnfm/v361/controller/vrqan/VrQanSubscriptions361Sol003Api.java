...
@RequestMapping(value = "/sol003/vrqan/v1/subscriptions", headers = "Version=1.2.1")
@RolesAllowed({ "ROLE_NFVO" })
@Validated
public interface VrQanSubscriptions361Sol003Api {

	Logger log = LoggerFactory.getLogger(VrQanSubscriptions361Sol003Api.class);
	...
	@Operation(summary = "", description = "The GET method queries the list of active subscriptions of the functional block that invokes the method. It can be used e.g. for resynchronization after error situations. See clause 11.4.2.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK  Shall be returned when the list of subscriptions has been queried successfully. The response body shall contain in an array the representations of all active subscriptions of the functional block that invokes the method, i.e. zero or more representations of virtualised resource quota available subscriptions as defined in clause 11.5.2.3. If the \"filter\" URI parameter was supplied in the request, the data in the response body shall have been transformed according to the rules specified in clause 5.2.2 of ETSI GS NFV-SOL 013. If the VNFM supports alternative 2 (paging) according to clause 5.4.2.1 of ETSI GS NFV-SOL 013 for this resource, inclusion of the Link HTTP header in this response shall follow the provisions in clause 5.4.2.3 of ETSI GS NFV-SOL 013. ", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = VrQuotaAvailSubscription.class)))),

			@ApiResponse(responseCode = "204", description = "No Content  The notification endpoint was tested successfully. The response body shall be empty. "),
	...
	default ResponseEntity<List<VrQuotaAvailSubscription>> subscriptionsGet(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization, @Parameter(in = ParameterIn.QUERY, description = "Attribute-based filtering expression according to clause 5.2 of ETSI GS NFV-SOL 013 [8]. The NFVO shall support receiving this parameter as part of the URI query string. The VNFM may supply this parameter. All attribute names that appear in the VrQuotaAvailSubscription and in data types referenced from it shall be supported by the NFVO in the filter expression. ", schema = @Schema()) @Valid @RequestParam(value = "filter", required = false) final String filter,
		...
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("[ {\n  \"filter\" : {\n    \"resourceTypes\" : [ \"COMPUTE\", \"COMPUTE\" ],\n    \"vimIds\" : [ null, null ],\n    \"resourceGroupIds\" : [ \"resourceGroupIds\", \"resourceGroupIds\" ],\n    \"resourceProviderIds\" : [ null, null ]\n  },\n  \"_links\" : {\n    \"self\" : { }\n  },\n  \"callbackUri\" : \"callbackUri\",\n  \"id\" : \"id\"\n}, {\n  \"filter\" : {\n    \"resourceTypes\" : [ \"COMPUTE\", \"COMPUTE\" ],\n    \"vimIds\" : [ null, null ],\n    \"resourceGroupIds\" : [ \"resourceGroupIds\", \"resourceGroupIds\" ],\n    \"resourceProviderIds\" : [ null, null ]\n  },\n  \"_links\" : {\n    \"self\" : { }\n  },\n  \"callbackUri\" : \"callbackUri\",\n  \"id\" : \"id\"\n} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
	...
	@Operation(summary = "", description = "The POST method creates a new subscription. See clause 11.4.2.3.1. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "201 CREATED  Shall be returned when the subscription has been created successfully. The response body shall contain a representation of the created \"Individual subscription\" resource. The HTTP response shall include a \"Location\" HTTP header that points to the created resource. ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = VrQuotaAvailSubscription.class))),
			...
			@ApiResponse(responseCode = "422", description = "422 Unprocessable Entity  Shall be returned upon the following error: The content type of the payload body is supported and the payload body of a request contains syntactically correct data but the data cannot be processed. The general cause for this error and its handling is specified in clause 6.4 of ETSI GS NFV-SOL 013 [8], including rules for the presence of the response body. Specifically in case of this resource, the response code 422 shall also be returned if the NFVO has tested the Notification endpoint as described in clause 11.4.4.3.2 and the test has failed. In this case, the \"detail\" attribute in the \"ProblemDetails\" structure shall convey more information about the error ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProblemDetails.class))),
	...
	default ResponseEntity<VrQuotaAvailSubscription> subscriptionsPost(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 ", required = true, schema = @Schema()) @RequestHeader(value = "Content-Type", required = true) final String contentType, @Parameter(in = ParameterIn.DEFAULT, description = "Details of the subscription to be created.", required = true, schema = @Schema()) @Valid @RequestBody final VrQuotaAvailSubscriptionRequest body,
		...
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"filter\" : {\n    \"resourceTypes\" : [ \"COMPUTE\", \"COMPUTE\" ],\n    \"vimIds\" : [ null, null ],\n    \"resourceGroupIds\" : [ \"resourceGroupIds\", \"resourceGroupIds\" ],\n    \"resourceProviderIds\" : [ null, null ]\n  },\n  \"_links\" : {\n    \"self\" : { }\n  },\n  \"callbackUri\" : \"callbackUri\",\n  \"id\" : \"id\"\n}", VrQuotaAvailSubscription.class), HttpStatus.NOT_IMPLEMENTED);
				} catch (final IOException e) {
					log.error("Couldn't serialize response for content type application/json", e);
					return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
				}
	...
	@Operation(summary = "", description = "The DELETE method terminates an individual subscription. See clause 11.4.3.3.5. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "204", description = "No Content  Shall be returned when the \"Individual subscription\" resource has been deleted successfully. "),
	...
	default ResponseEntity<VrQuotaAvailSubscription> subscriptionsSubscriptionIdGet(@Parameter(in = ParameterIn.PATH, description = "Identifier of this subscription. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request creating a new \"Individual subscription\" resource. It can also be retrieved from the \"id\" attribute in the payload body of that response. ", required = true, schema = @Schema()) @PathVariable("subscriptionId") final String subscriptionId, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"filter\" : {\n    \"resourceTypes\" : [ \"COMPUTE\", \"COMPUTE\" ],\n    \"vimIds\" : [ null, null ],\n    \"resourceGroupIds\" : [ \"resourceGroupIds\", \"resourceGroupIds\" ],\n    \"resourceProviderIds\" : [ null, null ]\n  },\n  \"_links\" : {\n    \"self\" : { }\n  },\n  \"callbackUri\" : \"callbackUri\",\n  \"id\" : \"id\"\n}", VrQuotaAvailSubscription.class), HttpStatus.NOT_IMPLEMENTED);
