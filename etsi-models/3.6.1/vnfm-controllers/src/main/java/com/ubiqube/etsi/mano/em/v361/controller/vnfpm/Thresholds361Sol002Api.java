...
public interface Thresholds361Sol002Api {
	...
	Logger log = LoggerFactory.getLogger(Thresholds361Sol002Api.class);
	...
	@Operation(summary = "", description = "The POST method can be used by API consumer to create a threshold. See clause 6.4.5.3.1. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "201 CREATED Shall be returned when a threshold has been created successfully.  The response body shall contain a representation of the created  \"Individual threshold\" resource. The HTTP response shall include a \"Location\" HTTP header that contains the resource URI of the created resource. ", content = @Content(schema = @Schema(implementation = Threshold.class))),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "204", description = "204 NO CONTENT Shall be returned when the threshold was deleted successfully. The response body shall be empty. "),
	...
	@Operation(summary = "", description = "The client can use this method for reading an individual threshold. See clause 6.4.6.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when information about an individual threshold  has been queried successfully. The response body shall contain a representation of the threshold. ", content = @Content(schema = @Schema(implementation = Threshold.class))),
