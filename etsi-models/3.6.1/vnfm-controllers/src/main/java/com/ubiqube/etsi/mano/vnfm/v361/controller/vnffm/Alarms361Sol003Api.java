...
@RequestMapping(value = "/sol003/vnffm/v1", headers = { "Version=1.4.0" })
@RolesAllowed({ "ROLE_NFVO" })
public interface Alarms361Sol003Api {

	Logger log = LoggerFactory.getLogger(Alarms361Sol003Api.class);
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK  Shall be returned when the request has been accepted and completed. The response body shall contain attribute modifications for an \"Individual alarm\" resource (see clause 7.5.2.4). ", content = @Content(schema = @Schema(implementation = AlarmModifications.class))),
			...
			@ApiResponse(responseCode = "409", description = "409 CONFLICT  Shall be returned upon the following error: The operation cannot be executed currently, due to a conflict with the state of the \"Individual alarm\" resource. Typically, this is due to the fact that the alarm is already in the state that is requested to be set (such as trying to acknowledge an already-acknowledged alarm). The response body shall contain a ProblemDetails structure, in which the \"detail\" attribute shall convey more information about the error ", content = @Content(schema = @Schema(implementation = ProblemDetails2.class))),
