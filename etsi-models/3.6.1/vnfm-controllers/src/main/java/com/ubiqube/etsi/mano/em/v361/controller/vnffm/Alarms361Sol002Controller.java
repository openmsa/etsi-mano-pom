 ...
 */
package com.ubiqube.etsi.mano.em.v361.controller.vnffm;
...
import com.ubiqube.etsi.mano.em.v361.model.vnffm.PerceivedSeverityRequest;
...
public class Alarms361Sol002Controller implements Alarms361Sol002Api {
	...
	public Alarms361Sol002Controller(final AlarmFrontController alarmFrontController) {
		super();
	...
	public ResponseEntity<Alarm> alarmsAlarmIdGet(final String alarmId) {
		return alarmFrontController.findById(alarmId, Alarm.class, Alarms361Sol002Controller::makeLinks);
	}
	...
	public ResponseEntity<String> alarmsGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return alarmFrontController.search(requestParams, Alarm.class, Alarms361Sol002Controller::makeLinks);
	}
