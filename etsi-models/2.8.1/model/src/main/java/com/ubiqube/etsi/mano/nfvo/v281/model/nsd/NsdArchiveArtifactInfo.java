...
public class NsdArchiveArtifactInfo {
	 ...
	 * @return artifactPath
	 **/
	@ApiModelProperty(required = true, value = "Path in the NSD archive, which identifies the artifact and also allows to access a copy of the artifact. ")
	@NotNull
	 ...
	 * @return metadata
	 **/
	@ApiModelProperty(value = "The metadata of the artifact that are available in the NSD Archive, such as Content type, size, creation date, etc. ")
