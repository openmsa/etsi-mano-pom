...
public class VnfLcmOpOcc {
	...
	/**
	 * Identifier of the grant related to this VNF LCM operation occurrence. Shall
	 * be set to the value of the \"id\" attribute in the \"Grant\" representing the
	 * associated \"Individual Grant\", if such grant exists.
	 *
	 * @return grantId
	 **/
	@ApiModelProperty(value = "Identifier of the grant related to this VNF LCM operation occurrence. Shall be set to the value of the \"id\" attribute  in the \"Grant\" representing the associated \"Individual Grant\",  if such grant exists. ")
	 ...
	 * TerminateVnfRequest * MODIFY_INFO: VnfInfoModifications This attribute shall
	 * be present if this data type is returned in a response to reading an
	 ...
	 * configurable properties, if applicable. This allows the NFVO/API consumer to
	 * obtain the information contained in the latest \"result\" notification if it
	 * has not received it due to an error or a wrongly configured subscription
	 * filter.
	 *
	 * @return changedInfo
	 **/
	@ApiModelProperty(value = "Information about the changed VNF instance information, including VNF configurable properties, if applicable. This allows the NFVO/API consumer to obtain the information contained in the latest \"result\" notification if it has not received it due to an error or a wrongly configured subscription filter. ")
	 ...
	 * the NFVO/API consumer to obtain the information contained in the latest
	 ...
	 **/
	@ApiModelProperty(value = "Information about changed external connectivity, if applicable. This allows the NFVO/API consumer to obtain the information contained in the latest \"result\" notification if it has not received it due to an error or a wrongly configured subscription filter. ")
