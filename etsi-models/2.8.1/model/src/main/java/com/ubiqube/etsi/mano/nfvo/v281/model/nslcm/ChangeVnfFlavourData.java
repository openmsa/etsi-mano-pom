...
public class ChangeVnfFlavourData {
   ...
   * @return extensions
   **/
  @Schema(description = "This attribute provides values for the \"extensions\" input parameter of the Change VNF Flavour operation defined in ETSI GS NFV-SOL 003. ")
   ...
   **/
  @Schema(description = "This attribute provides values for the \"vnfConfigurableProperties\" input parameter of the Change VNF Flavour operation defined in ETSI GS NFV SOL 003. ")
