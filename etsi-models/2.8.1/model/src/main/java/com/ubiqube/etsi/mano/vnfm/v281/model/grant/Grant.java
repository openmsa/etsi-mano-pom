...
public class Grant {
  ...
  /**
   * Identifier of the related VNF instance. See note 6. NOTE 6: The NFVO shall
   * set the value of the attribute by copying the value from the associated
   * GrantRequest.
   *
  ...
  /**
   * Identifier of the related VNF lifecycle management operation occurrence. See
   * note 6. NOTE 6: The NFVO shall set the value of the attribute by copying the
   * value from the associated GrantRequest.
   *
   ...
   * note 1. NOTE 1: This interface allows to signal the use of multiple VIMs per
   * VNF. However, due to the partial support of this feature in the present
   * release, it is recommended in the present document that the number of entries
   * in the \"vims\" attribute in the Grant is not greater than 1.
   *
   ...
   * requirements of the corresponding grant request. See note 2. NOTE 2: At least
   * one of (computeReservationId, networkReservationId, storageReservationId)
   * shall be present when policy is GRANT_RESERVE_SINGLE and an applicable
   * reservation exists. None of these shall be present otherwise.
   *
   * @return computeReservationId
   **/
  @Schema(description = "Information that identifies a reservation applicable to the compute resource requirements of the corresponding grant request. See note 2. NOTE 2: At least one of (computeReservationId, networkReservationId, storageReservationId) shall be present when policy is GRANT_RESERVE_SINGLE and an applicable reservation exists. None of these shall be present otherwise. ")
   ...
   **/
  @Schema(description = "Information that identifies a reservation applicable to the network resource requirements of the corresponding grant request. See note 2. NOTE 2: At least one of (computeReservationId, networkReservationId, storageReservationId) shall be present when policy is GRANT_RESERVE_SINGLE and an applicable reservation exists. None of these shall be present otherwise. ")
   ...
   **/
  @Schema(description = "Information that identifies a reservation applicable to the storage resource requirements of the corresponding grant request. See note 2. NOTE 2: At least one of (computeReservationId, networkReservationId, storageReservationId) shall be present when policy is GRANT_RESERVE_SINGLE and an applicable reservation exists. None of these shall be present otherwise. ")
   ...
   * passed in the LCM operation which is related to this granting exchange. NOTE
   * 5: External and/or externally-managed internal VLs can be passed in VNF
   * lifecycle management operation requests such as InstantiateVnf,
   * ChangeVnfFlavour or ChangeExtVnfConnectivity and/or in the grant response.
   ...
   * request has originated from the NFVO itself. NOTE 7: In case of granting an
   ...
   * VNFM. See note 4, note 5 and note 57 NOTE 4: The indication of
   ...
   * towards the VIM). NOTE 5: External and/or externally-managed internal VLs can
   * be passed in VNF lifecycle management operation requests such as
   * InstantiateVnf, ChangeVnfFlavour or ChangeExtVnfConnectivity and/or in the
   ...
   * lifecycle management request has originated from the NFVO itself. NOTE 7: In
   * case of granting an InstantiateVnf request that has originated from the NFVO
   * and that did not contain the \"extVirtualLinks\" attribute, this attribute
   * shall be set by the NFVO. Further in case of granting an InstantiateVnf
