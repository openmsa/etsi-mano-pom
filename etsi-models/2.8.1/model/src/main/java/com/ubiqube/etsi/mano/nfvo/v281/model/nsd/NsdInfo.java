...
public class NsdInfo {
	...
	/**
	 * The singleton signing certificate if it is included as a file in the NSD
	 * archive.
	 *
	 * @return signingCertificate
	 **/
	@ApiModelProperty(value = "The singleton signing certificate if it is included as a file in the NSD archive. ")
	 ...
	 * present when the \"nsdOnboardingState\" attribute is \"ERROR\", i.e. the
	 * uploading or processing has failed in NFVO, unless it has been requested to
	 * be excluded via an attribute selector.
	 *
	 * @return onboardingFailureDetails
	 **/
	@ApiModelProperty(value = "Failure details of current on boarding procedure. See clause 6.3 of ETSI GS NFV-SOL 013 for the details of \"ProblemDetails\" structure. It shall be present when the \"nsdOnboardingState\" attribute is \"ERROR\", i.e. the uploading or processing has failed in NFVO, unless it has been requested to be excluded via an attribute selector. ")
