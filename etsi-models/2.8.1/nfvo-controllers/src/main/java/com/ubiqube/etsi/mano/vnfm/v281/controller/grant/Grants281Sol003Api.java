...
public interface Grants281Sol003Api {
	...
	ResponseEntity<Grant> grantsGrantIdGet(@ApiParam(value = "Identifier of the grant. This identifier can be retrieved from the resource referenced by the \"Location\" HTTP header in the response to a POST request granting a new VNF lifecycle operation. It can also be retrieved from the \"id\" attribute in the payload body of that response. ", required = true) @PathVariable("grantId") String grantId);
