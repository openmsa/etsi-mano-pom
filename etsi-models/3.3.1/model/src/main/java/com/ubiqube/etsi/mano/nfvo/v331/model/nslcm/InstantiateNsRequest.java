...
import com.ubiqube.etsi.mano.nfvo.v331.model.nslcm.ParamsForVnf;
...
import com.ubiqube.etsi.mano.nfvo.v331.model.nslcm.WanConnectionData;
...
public class InstantiateNsRequest   {
  ...
  /**
   * Information for connecting VNs to the WAN when VLs are deployed across a WAN. When the NS is deployed over several sites, the VLs of this NS will include VNs in each site connected over the WAN. In this case, the \"wanConnectionData\" provides the needed information required to connect each VN to the WAN. Annex E provides additional information and guidelines about the usage of the \"wanConnectionData\" attribute. 
   * @return wanConnectionData
   **/
  @Schema(description = "Information for connecting VNs to the WAN when VLs are deployed across a WAN. When the NS is deployed over several sites, the VLs of this NS will include VNs in each site connected over the WAN. In this case, the \"wanConnectionData\" provides the needed information required to connect each VN to the WAN. Annex E provides additional information and guidelines about the usage of the \"wanConnectionData\" attribute. ")
      @Valid
  ...
  @Override
  public int hashCode() {
    return Objects.hash(nsFlavourId, sapData, addpnfData, vnfInstanceData, nestedNsInstanceData, locationConstraints, nestedNslocationConstraints, additionalParamsForNs, additionalParamForNestedNs, additionalParamsForVnf, startTime, nsInstantiationLevelId, wanConnectionData, additionalAffinityOrAntiAffinityRule);
  }
