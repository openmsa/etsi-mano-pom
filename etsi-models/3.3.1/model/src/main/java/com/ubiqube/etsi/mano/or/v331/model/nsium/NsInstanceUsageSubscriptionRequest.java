 ...
 * instance usage. It shall comply with the provisions defined in table
 * 8.6.2.2-1.
 */
...
public class NsInstanceUsageSubscriptionRequest {
	...
	public NsInstanceUsageSubscriptionRequest filter(final NsInstanceUsageNotificationsFilter filter) {
		this.filter = filter;
		return this;
	}
	...
	public void setFilter(final NsInstanceUsageNotificationsFilter filter) {
		this.filter = filter;
	}

	public NsInstanceUsageSubscriptionRequest callbackUri(final String callbackUri) {
	...
	public NsInstanceUsageSubscriptionRequest authentication(final SubscriptionAuthentication authentication) {
	...
	public boolean equals(final java.lang.Object o) {
		...
		final NsInstanceUsageSubscriptionRequest nsInstanceUsageSubscriptionRequest = (NsInstanceUsageSubscriptionRequest) o;
