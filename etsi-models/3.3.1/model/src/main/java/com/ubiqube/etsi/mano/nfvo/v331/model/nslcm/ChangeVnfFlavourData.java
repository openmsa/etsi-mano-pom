...
public class ChangeVnfFlavourData {
	 ...
	 * that xternally-managed internal VLs are managed by the NFVO and created
	 * towards the VIM. It is possible to have several ExtManagedVirtualLinkData for
	 * the same VNF internal VL in case of a multi-site VNF spanning several VIMs.
	 * The set of ExtManagedVirtualLinkData corresponding to the same VNF internal
	 * VL shall indicate so by referencing to the same VnfVirtualLinkDesc and
	 * externally-managed multi-site VL instance (refer to clause 6.5.3.27).
	 *
	 * @return extManagedVirtualLinks
	 **/
	@Schema(description = "information about internal VLs that are managed by NFVO. The indication of externally-managed internal VLs is needed in case networks have been pre-configured for use with certain VNFs, for instance to ensure that these networks have certain properties such as security or acceleration features, or to address particular network topologies. The present document assumes that xternally-managed internal VLs are managed by the NFVO and created towards the VIM. It is possible to have several ExtManagedVirtualLinkData for the same VNF internal VL in case of a multi-site VNF spanning several VIMs. The set of ExtManagedVirtualLinkData corresponding to the same VNF internal VL shall indicate so by referencing to the same VnfVirtualLinkDesc and externally-managed multi-site VL instance (refer to clause 6.5.3.27). ")
	@Valid
