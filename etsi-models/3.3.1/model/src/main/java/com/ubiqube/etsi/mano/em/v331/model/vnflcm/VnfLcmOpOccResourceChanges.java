...
import com.ubiqube.etsi.mano.em.v331.model.vnflcm.AffectedExtLinkPort;
import com.ubiqube.etsi.mano.em.v331.model.vnflcm.AffectedVirtualLink;
import com.ubiqube.etsi.mano.em.v331.model.vnflcm.AffectedVirtualStorage;
import com.ubiqube.etsi.mano.em.v331.model.vnflcm.AffectedVnfc;
...
public class VnfLcmOpOccResourceChanges   {
   ...
   **/
  @Schema(description = "Information about VNFC instances that were affected during the lifecycle operation. This allows the API consumer to obtain the information contained in the latest \"result\" notification if it has not received it due to an error or a wrongly configured subscription filter. ")
      @Valid
   ...
   **/
  @Schema(description = "Information about external VNF link ports that were affected during the lifecycle operation. This allows the API consumer to obtain the information contained in the latest \"result\" notification if it has not received it due to an error or a wrongly configured subscription filter. ")
      @Valid
