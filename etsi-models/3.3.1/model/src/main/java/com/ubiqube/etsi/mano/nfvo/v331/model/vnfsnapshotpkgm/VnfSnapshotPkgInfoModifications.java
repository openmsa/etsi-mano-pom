 ...
 */
@Schema(description = "This type represents modifications to the information of a VNF snapshot package.  It shall comply with the provisions defined in table 11.5.2.4-1. ")
@Validated
...
public class VnfSnapshotPkgInfoModifications  implements AnyOfVnfSnapshotPkgInfoModifications {
  ...
  /**
   * New value of the human-readable name of the VNF snapshot package.  At least one of the three parameters shall be present. If the VNF snapshot package  is not uploaded or built, the operation is used only to update existing or add additional  user defined data using the userDefinedData attribute. 
   * @return name
   **/
  @Schema(description = "New value of the human-readable name of the VNF snapshot package.  At least one of the three parameters shall be present. If the VNF snapshot package  is not uploaded or built, the operation is used only to update existing or add additional  user defined data using the userDefinedData attribute. ")
   ...
   * @return state
   **/
  @Schema(description = "New value of the \"state\" of the VNF snapshot package. Permitted values:  - AVAILABLE: to change the \"Individual VNF snapshot package\" resource state to \"AVAILABLE\". Explicit change of state is only permitted from the following states: - ERROR_EXTRACTING  At least one of the three parameters shall be present. If the VNF snapshot package  is not uploaded or built, the operation is used only to update existing or add additional  user defined data using the userDefinedData attribute. ")
