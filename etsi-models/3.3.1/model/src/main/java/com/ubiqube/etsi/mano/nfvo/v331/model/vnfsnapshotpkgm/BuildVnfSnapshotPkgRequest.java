...
/**
 * This type represents the request parameters for building the content of a VNF snapshot package. The NFVO can obtain the VNF snapshot data through the information provided in the request  parameters. It shall comply with the provisions defined in table 11.5.2.6-1. 
 */
@Schema(description = "This type represents the request parameters for building the content of a VNF snapshot package. The NFVO can obtain the VNF snapshot data through the information provided in the request  parameters. It shall comply with the provisions defined in table 11.5.2.6-1. ")
@Validated
...
public class BuildVnfSnapshotPkgRequest   {
  ...
  /**
   * If present, it indicates the list of VNFC snapshots to which the VNF snapshot-level  import snapshot resource policy indicated by the \"importSnapshotResource\" attribute  does not apply and the opposite value shall be considered.   The \"overrideImportForVnfcSnapshotIds\" provides the list of VNFC snapshots for which the  VNF snapshot-level snapshot resource import policy is overridden. See also examples in the  present clause. 
   * @return overrideImportForVnfcSnapshotIds
   **/
  @Schema(description = "If present, it indicates the list of VNFC snapshots to which the VNF snapshot-level  import snapshot resource policy indicated by the \"importSnapshotResource\" attribute  does not apply and the opposite value shall be considered.   The \"overrideImportForVnfcSnapshotIds\" provides the list of VNFC snapshots for which the  VNF snapshot-level snapshot resource import policy is overridden. See also examples in the  present clause. ")
