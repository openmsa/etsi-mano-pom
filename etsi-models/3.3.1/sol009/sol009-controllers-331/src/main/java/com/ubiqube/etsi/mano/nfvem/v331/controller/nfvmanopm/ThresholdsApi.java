...
public interface ThresholdsApi {
	...
	Logger log = LoggerFactory.getLogger(ThresholdsApi.class);
	...
	default ResponseEntity<List<Threshold>> thresholdsGet(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.QUERY, description = "Attribute-based filtering expression according to clause 5.2 of  ETSI GS NFV-SOL 013.  The NFV-MANO functional entity shall support receiving this parameter  as part of the URI query string. The API consumer may supply this  parameter.  All attribute names that appear in the Threshold  and in data  types referenced from it shall be supported by the NFV-MANO functional  entity in the expression.  ", schema = @Schema()) @Valid @RequestParam(value = "filter", required = false) final String filter,
		...
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("[ {\n  \"_links\" : {\n    \"self\" : { }\n  },\n  \"criteria\" : {\n    \"simpleThresholdDetails\" : {\n      \"thresholdValue\" : 0.8008281904610115\n    },\n    \"performanceMetric\" : \"performanceMetric\",\n    \"thresholdType\" : \"SIMPLE\"\n  },\n  \"id\" : \"id\",\n  \"objectType\" : \"objectType\",\n  \"subjObjectInstanceIds\" : [ \"subjObjectInstanceIds\", \"subjObjectInstanceIds\" ]\n}, {\n  \"_links\" : {\n    \"self\" : { }\n  },\n  \"criteria\" : {\n    \"simpleThresholdDetails\" : {\n      \"thresholdValue\" : 0.8008281904610115\n    },\n    \"performanceMetric\" : \"performanceMetric\",\n    \"thresholdType\" : \"SIMPLE\"\n  },\n  \"id\" : \"id\",\n  \"objectType\" : \"objectType\",\n  \"subjObjectInstanceIds\" : [ \"subjObjectInstanceIds\", \"subjObjectInstanceIds\" ]\n} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
	...
	@Operation(summary = "", description = "The POST method can be used by the client to create a threshold. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "201 CREATED Shall be returned when a threshold has been created successfully.  The response body shall contain a representation of the created  \"Individual threshold\" resource, as defined in clause 6.6.2.9. The HTTP response shall include a \"Location\" HTTP header that  contains the resource URI of the created \"Individual threshold\"  resource. ", content = @Content(schema = @Schema(implementation = Threshold.class))),
	...
	default ResponseEntity<Threshold> thresholdsPost(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.DEFAULT, description = "Request parameters to create a threshold. ", required = true, schema = @Schema()) @Valid @RequestBody final CreateThresholdRequest body, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
	...
	@Operation(summary = "", description = "This method allows to delete a threshold. ", tags = {})
	@ApiResponses(value = {
	...
	@Operation(summary = "", description = "The client can use this method for reading an individual threshold  ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when information about an individual threshold  has been read successfully. The response body shall contain a representation of the threshold,  as defined in clause 6.6.2.9. ", content = @Content(schema = @Schema(implementation = Threshold.class))),
