...
public interface PmJobsApi {

	Logger log = LoggerFactory.getLogger(PmJobsApi.class);
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when information about zero or more PM jobs has  been queried successfully. The response body shall contain in an array the representations  of zero or more PM jobs, as defined in clause 6.6.2.7. If the \"filter\" URI parameter or one of the \"all_fields\", \"fields\"  (if supported), \"exclude_fields\" (if supported) or \"exclude_default\"  URI parameters was supplied in the request, the data in the response  body shall have been transformed according to the rules specified in  clauses 5.2.2 and 5.3.2 of ETSI GS NFV-SOL 013, respectively. If the NFV-MANO functional entity supports alternative 2 (paging)  according to clause 5.4.2.1 of ETSI GS NFV-SOL 013 for this  resource, inclusion of the Link HTTP header in this response shall  follow the provisions in clause 5.4.2.3 of ETSI GS NFV-SOL 013 . ", content = @Content(array = @ArraySchema(schema = @Schema(implementation = PmJob.class)))),
			...
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue(
							"[ {\n  \"reports\" : [ {\n    \"fileSize\" : 1.4658129805029452,\n    \"href\" : \"href\"\n  }, {\n    \"fileSize\" : 1.4658129805029452,\n    \"href\" : \"href\"\n  } ],\n  \"subObjectInstanceIds\" : [ \"subObjectInstanceIds\", \"subObjectInstanceIds\" ],\n  \"_links\" : {\n    \"objects\" : [ null, null ],\n    \"self\" : { }\n  },\n  \"objectInstanceIds\" : [ null, null ],\n  \"criteria\" : {\n    \"collectionPeriod\" : 0,\n    \"reportingPeriod\" : 6,\n    \"reportingBoundary\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"performanceMetricGroup\" : [ \"performanceMetricGroup\", \"performanceMetricGroup\" ],\n    \"performanceMetric\" : [ \"performanceMetric\", \"performanceMetric\" ]\n  },\n  \"id\" : \"id\",\n  \"objectType\" : \"objectType\"\n}, {\n  \"reports\" : [ {\n    \"fileSize\" : 1.4658129805029452,\n    \"href\" : \"href\"\n  }, {\n    \"fileSize\" : 1.4658129805029452,\n    \"href\" : \"href\"\n  } ],\n  \"subObjectInstanceIds\" : [ \"subObjectInstanceIds\", \"subObjectInstanceIds\" ],\n  \"_links\" : {\n    \"objects\" : [ null, null ],\n    \"self\" : { }\n  },\n  \"objectInstanceIds\" : [ null, null ],\n  \"criteria\" : {\n    \"collectionPeriod\" : 0,\n    \"reportingPeriod\" : 6,\n    \"reportingBoundary\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"performanceMetricGroup\" : [ \"performanceMetricGroup\", \"performanceMetricGroup\" ],\n    \"performanceMetric\" : [ \"performanceMetric\", \"performanceMetric\" ]\n  },\n  \"id\" : \"id\",\n  \"objectType\" : \"objectType\"\n} ]",
	...
	@Operation(summary = "", description = "This method terminates an individual PM job. ", tags = {})
	@ApiResponses(value = {
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when information about an individual PM job  has been read successfully. The response body shall contain a representation of the \"Individual PM job\" resource, as defined in clause 6.6.2.7. ", content = @Content(schema = @Schema(implementation = PmJob.class))),
	...
	default ResponseEntity<PmJob> pmJobsPmJobIdGet(@Parameter(in = ParameterIn.PATH, description = "Identifier of the PM Job", required = true, schema = @Schema()) @PathVariable("pmJobId") final String pmJobId, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"reports\" : [ {\n    \"fileSize\" : 1.4658129805029452,\n    \"href\" : \"href\"\n  }, {\n    \"fileSize\" : 1.4658129805029452,\n    \"href\" : \"href\"\n  } ],\n  \"subObjectInstanceIds\" : [ \"subObjectInstanceIds\", \"subObjectInstanceIds\" ],\n  \"_links\" : {\n    \"objects\" : [ null, null ],\n    \"self\" : { }\n  },\n  \"objectInstanceIds\" : [ null, null ],\n  \"criteria\" : {\n    \"collectionPeriod\" : 0,\n    \"reportingPeriod\" : 6,\n    \"reportingBoundary\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"performanceMetricGroup\" : [ \"performanceMetricGroup\", \"performanceMetricGroup\" ],\n    \"performanceMetric\" : [ \"performanceMetric\", \"performanceMetric\" ]\n  },\n  \"id\" : \"id\",\n  \"objectType\" : \"objectType\"\n}", PmJob.class), HttpStatus.NOT_IMPLEMENTED);
				} catch (final IOException e) {
					log.error("Couldn't serialize response for content type application/json", e);
					return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
				}
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when information of an individual performance  report has been read successfully. The response body shall contain a representation of the  \"Individual performance report\" resource, as defined  in clause 6.6.2.10. ", content = @Content(schema = @Schema(implementation = PerformanceReport.class))),
	...
	default ResponseEntity<PerformanceReport> pmJobsPmJobIdReportsReportIdGet(@Parameter(in = ParameterIn.PATH, description = "Identifier of the PM Job", required = true, schema = @Schema()) @PathVariable("pmJobId") final String pmJobId, @Parameter(in = ParameterIn.PATH, description = "Identifier of the PM report", required = true, schema = @Schema()) @PathVariable("reportId") final String reportId, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"entries\" : [ {\n    \"objectInstanceId\" : {\n      \"subObjectId\" : \"subObjectId\",\n      \"type\" : \"MANO_ENTITY\",\n      \"objectId\" : \"objectId\"\n    },\n    \"performanceMetric\" : \"performanceMetric\",\n    \"performanceValues\" : [ {\n      \"timeStamp\" : \"2000-01-23T04:56:07.000+00:00\",\n      \"context\" : { },\n      \"value\" : \"\"\n    }, {\n      \"timeStamp\" : \"2000-01-23T04:56:07.000+00:00\",\n      \"context\" : { },\n      \"value\" : \"\"\n    } ],\n    \"objectType\" : \"objectType\"\n  }, {\n    \"objectInstanceId\" : {\n      \"subObjectId\" : \"subObjectId\",\n      \"type\" : \"MANO_ENTITY\",\n      \"objectId\" : \"objectId\"\n    },\n    \"performanceMetric\" : \"performanceMetric\",\n    \"performanceValues\" : [ {\n      \"timeStamp\" : \"2000-01-23T04:56:07.000+00:00\",\n      \"context\" : { },\n      \"value\" : \"\"\n    }, {\n      \"timeStamp\" : \"2000-01-23T04:56:07.000+00:00\",\n      \"context\" : { },\n      \"value\" : \"\"\n    } ],\n    \"objectType\" : \"objectType\"\n  } ]\n}", PerformanceReport.class), HttpStatus.NOT_IMPLEMENTED);
				} catch (final IOException e) {
					log.error("Couldn't serialize response for content type application/json", e);
					return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
				}
	...
	@Operation(summary = "", description = "Creates a PM job. This method shall follow the provisions specified in the tables  6.5.3.3.1-1 and 6.5.3.3.1-2 for URI query parameters, request and  response data structures, and response codes. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "201 CREATED Shall be returned when the PM job has been created successfully. The response body shall contain a representation of the created  \"Individual PM job\" resource, as defined in clause 6.6.2.7. The HTTP response shall include a \"Location\" HTTP header that  points to the created \"Individual PM job\" resource. ", content = @Content(schema = @Schema(implementation = PmJob.class))),
	...
	default ResponseEntity<PmJob> pmJobsPost(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.DEFAULT, description = "PM job creation request.", required = true, schema = @Schema()) @Valid @RequestBody final CreatePmJobRequest body, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"reports\" : [ {\n    \"fileSize\" : 1.4658129805029452,\n    \"href\" : \"href\"\n  }, {\n    \"fileSize\" : 1.4658129805029452,\n    \"href\" : \"href\"\n  } ],\n  \"subObjectInstanceIds\" : [ \"subObjectInstanceIds\", \"subObjectInstanceIds\" ],\n  \"_links\" : {\n    \"objects\" : [ null, null ],\n    \"self\" : { }\n  },\n  \"objectInstanceIds\" : [ null, null ],\n  \"criteria\" : {\n    \"collectionPeriod\" : 0,\n    \"reportingPeriod\" : 6,\n    \"reportingBoundary\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"performanceMetricGroup\" : [ \"performanceMetricGroup\", \"performanceMetricGroup\" ],\n    \"performanceMetric\" : [ \"performanceMetric\", \"performanceMetric\" ]\n  },\n  \"id\" : \"id\",\n  \"objectType\" : \"objectType\"\n}", PmJob.class), HttpStatus.NOT_IMPLEMENTED);
