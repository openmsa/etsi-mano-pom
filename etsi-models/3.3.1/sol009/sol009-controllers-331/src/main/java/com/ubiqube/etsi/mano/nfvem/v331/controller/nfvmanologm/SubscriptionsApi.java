...
import com.ubiqube.etsi.mano.nfvem.v331.model.nfvmanologm.ProblemDetails;
...
public interface SubscriptionsApi {
    ...
    @Operation(summary = "", description = "The API consumer can use this method to query the list of active subscriptions to log management notifications subscribed by the API consumer. This method shall follow the provisions specified in the tables 8.5.7.3.2-1 and 8.5.7.3.2-2 for URI query parameters, request and response data structures, and response codes.", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Shall be returned when the list of subscriptions has been queried successfully. The response body shall contain in an array the representations of all active subscriptions of the functional block that invokes the method, i.e. zero or more representations of log management subscriptions as defined in clause 8.6.2.3. If the \"filter\" URI parameter was supplied in the request, the data in the response body shall have been transformed according to the rules specified in clause 5.2.2 of ETSI GS NFV-SOL 013. If the NFV-MANO functional entity supports alternative 2 (paging) according to clause 5.4.2.1 of ETSI GS NFV-SOL 013 for this resource, inclusion of the Link HTTP header in this response shall follow the provisions in clause 5.4.2.3 of ETSI GS NFV-SOL 013 .", content = @Content(array = @ArraySchema(schema = @Schema(implementation = LogmSubscription.class)))),
    ...
    default ResponseEntity<LogmSubscription> subscriptionsPost(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. " ,required=true,schema=@Schema()) @RequestHeader(value="Version", required=true) String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. " ,required=true,schema=@Schema()) @RequestHeader(value="Accept", required=true) String accept, @Parameter(in = ParameterIn.HEADER, description = "The MIME type of the body of the request. Reference: IETF RFC 7231 " ,required=true,schema=@Schema()) @RequestHeader(value="Content-Type", required=true) String contentType, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. " ,schema=@Schema()) @RequestHeader(value="Authorization", required=false) String authorization, @Parameter(in = ParameterIn.DEFAULT, description = "Details of the subscription to be created", schema=@Schema()) @Valid @RequestBody LogmSubscriptionRequest body) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"filter\" : {\n    \"notificationTypes\" : \"LogReportAvailableNotification\",\n    \"objectInstanceFilter\" : {\n      \"manoServiceInterfaceIds\" : [ null, null ],\n      \"consumedManoInterfaceNames\" : [ \"consumedManoInterfaceNames\", \"consumedManoInterfaceNames\" ],\n      \"manoServiceNames\" : [ \"manoServiceNames\", \"manoServiceNames\" ],\n      \"manoServiceInterfaceNames\" : [ \"manoServiceInterfaceNames\", \"manoServiceInterfaceNames\" ],\n      \"consumedManoInterfaceIds\" : [ null, null ],\n      \"manoServiceIds\" : [ \"manoServiceIds\", \"manoServiceIds\" ]\n    }\n  },\n  \"_links\" : {\n    \"self\" : {\n      \"href\" : \"href\"\n    }\n  },\n  \"callbackUri\" : \"callbackUri\",\n  \"id\" : \"id\"\n}", LogmSubscription.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
    ...
    @Operation(summary = "", description = "The API consumer can use this method for reading an individual subscription about log management notifications subscribed by the API consumer. This method shall follow the provisions specified in the tables 8.5.8.3.2-1 and 8.5.8.3.2-2 for URI query parameters, request and response data structures, and response codes.", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Shall be returned when the subscription has been read successfully. The response body shall contain a representation of the \"Individual subscription\" resource, as defined in clause 8.6.2.3.", content = @Content(schema = @Schema(implementation = LogmSubscription.class))),
    ...
    @RequestMapping(value = "/subscriptions/{subscriptionId}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<LogmSubscription> subscriptionsSubscriptionIdGet(@Parameter(in = ParameterIn.PATH, description = "Identifier of the subscription", required=true, schema=@Schema()) @PathVariable("subscriptionId") String subscriptionId, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. " ,required=true,schema=@Schema()) @RequestHeader(value="Version", required=true) String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. " ,required=true,schema=@Schema()) @RequestHeader(value="Accept", required=true) String accept, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. " ,schema=@Schema()) @RequestHeader(value="Authorization", required=false) String authorization) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"filter\" : {\n    \"notificationTypes\" : \"LogReportAvailableNotification\",\n    \"objectInstanceFilter\" : {\n      \"manoServiceInterfaceIds\" : [ null, null ],\n      \"consumedManoInterfaceNames\" : [ \"consumedManoInterfaceNames\", \"consumedManoInterfaceNames\" ],\n      \"manoServiceNames\" : [ \"manoServiceNames\", \"manoServiceNames\" ],\n      \"manoServiceInterfaceNames\" : [ \"manoServiceInterfaceNames\", \"manoServiceInterfaceNames\" ],\n      \"consumedManoInterfaceIds\" : [ null, null ],\n      \"manoServiceIds\" : [ \"manoServiceIds\", \"manoServiceIds\" ]\n    }\n  },\n  \"_links\" : {\n    \"self\" : {\n      \"href\" : \"href\"\n    }\n  },\n  \"callbackUri\" : \"callbackUri\",\n  \"id\" : \"id\"\n}", LogmSubscription.class), HttpStatus.NOT_IMPLEMENTED);
