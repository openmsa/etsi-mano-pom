...
public interface SubscriptionsApi {
	...
	@Operation(summary = "", description = "The client can use this method to query the list of active subscriptions  to performance management notifications subscribed by the client. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Shall be returned when the list of subscriptions has been queried  successfully. The response body shall contain in an array the representations  of all active subscriptions of the functional block that invokes  the method, i.e. zero or more representations of PM subscriptions  as defined in clause 6.6.2.3. If the \"filter\" URI parameter was supplied in the request, the data  in the response body shall have been transformed according to the  rules specified in clause 5.2.2 of ETSI GS NFV-SOL 013. If the NFV-MANO functional entity supports alternative 2 (paging)  according to clause 5.4.2.1 of ETSI GS NFV-SOL 013 for this resource,  inclusion of the Link HTTP header in this response shall follow the  provisions in clause 5.4.2.3 of ETSI GS NFV-SOL 013. ", content = @Content(array = @ArraySchema(schema = @Schema(implementation = PmSubscription.class)))),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "201 CREATED  Shall be returned when the subscription has been created successfully. A representation of the created subscription resource shall be returned  in the response body, as defined in clause 6.6.2.3. The HTTP response shall include a \"Location\" HTTP header that contains  the resource URI of the created \"Individual subscription\" resource. ", content = @Content(schema = @Schema(implementation = PmSubscription.class))),
	...
	default ResponseEntity<PmSubscription> subscriptionsPost(@Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.DEFAULT, description = "Details of the subscription to be created.", required = true, schema = @Schema()) @Valid @RequestBody final PmSubscriptionRequest body, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"filter\" : {\n    \"notificationTypes\" : \"ThresholdCrossedNotification\",\n    \"pmSubscriptionFilter\" : {\n      \"manoServiceInterfaceIds\" : [ null, null ],\n      \"consumedManoInterfaceNames\" : [ \"consumedManoInterfaceNames\", \"consumedManoInterfaceNames\" ],\n      \"manoServiceNames\" : [ \"manoServiceNames\", \"manoServiceNames\" ],\n      \"manoServiceInterfaceNames\" : [ \"manoServiceInterfaceNames\", \"manoServiceInterfaceNames\" ],\n      \"consumedManoInterfaceIds\" : [ null, null ],\n      \"manoServiceIds\" : [ \"manoServiceIds\", \"manoServiceIds\" ]\n    }\n  },\n  \"callbackUri\" : {\n    \"self\" : { },\n    \"links\" : \"links\"\n  },\n  \"id\" : \"id\"\n}", PmSubscription.class), HttpStatus.NOT_IMPLEMENTED);
				} catch (final IOException e) {
					log.error("Couldn't serialize response for content type application/json", e);
					return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
				}
	...
	@Operation(summary = "", description = "This method terminates an individual subscription. ", tags = {})
	@ApiResponses(value = {
	...
	@Operation(summary = "", description = "The client can use this method for reading an individual subscription  about performance management notifications subscribed by the client. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when the subscription has been read successfully. The response body shall contain a representation of the  \"Individual subscription\" resource, as defined in clause 6.6.2.3. ", content = @Content(schema = @Schema(implementation = PmSubscription.class))),
	...
	default ResponseEntity<PmSubscription> subscriptionsSubscriptionIdGet(@Parameter(in = ParameterIn.PATH, description = "Identifier of the subscription", required = true, schema = @Schema()) @PathVariable("subscriptionId") final String subscriptionId, @Parameter(in = ParameterIn.HEADER, description = "Version of the API requested to use when responding to this request. ", required = true, schema = @Schema()) @RequestHeader(value = "Version", required = true) final String version, @Parameter(in = ParameterIn.HEADER, description = "Content-Types that are acceptable for the response. Reference: IETF RFC 7231. ", required = true, schema = @Schema()) @RequestHeader(value = "Accept", required = true) final String accept, @Parameter(in = ParameterIn.HEADER, description = "The authorization token for the request. Reference: IETF RFC 7235. ", schema = @Schema()) @RequestHeader(value = "Authorization", required = false) final String authorization) {
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			if (getAcceptHeader().get().contains("application/json")) {
				try {
					return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"filter\" : {\n    \"notificationTypes\" : \"ThresholdCrossedNotification\",\n    \"pmSubscriptionFilter\" : {\n      \"manoServiceInterfaceIds\" : [ null, null ],\n      \"consumedManoInterfaceNames\" : [ \"consumedManoInterfaceNames\", \"consumedManoInterfaceNames\" ],\n      \"manoServiceNames\" : [ \"manoServiceNames\", \"manoServiceNames\" ],\n      \"manoServiceInterfaceNames\" : [ \"manoServiceInterfaceNames\", \"manoServiceInterfaceNames\" ],\n      \"consumedManoInterfaceIds\" : [ null, null ],\n      \"manoServiceIds\" : [ \"manoServiceIds\", \"manoServiceIds\" ]\n    }\n  },\n  \"callbackUri\" : {\n    \"self\" : { },\n    \"links\" : \"links\"\n  },\n  \"id\" : \"id\"\n}", PmSubscription.class), HttpStatus.NOT_IMPLEMENTED);
