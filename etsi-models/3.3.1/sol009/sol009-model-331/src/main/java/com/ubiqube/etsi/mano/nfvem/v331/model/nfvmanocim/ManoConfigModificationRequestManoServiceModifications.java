...
public class ManoConfigModificationRequestManoServiceModifications   {
  ...
  **/
   ...
   * @return name
  **/
  @Schema(description= "New value for the \"name\" attribute in the \"ManoService\".  NOTE: At least one of these attributes shall be provided if requesting  a modification of the NFV-MANO service identified by \"id\". " )
   ...
   * @return description
  **/
  @Schema(description= "New value for the \"description\" attribute in the \"ManoService\". NOTE: At least one of these attributes shall be provided if requesting  a modification of the NFV-MANO service identified by \"id\". " )
