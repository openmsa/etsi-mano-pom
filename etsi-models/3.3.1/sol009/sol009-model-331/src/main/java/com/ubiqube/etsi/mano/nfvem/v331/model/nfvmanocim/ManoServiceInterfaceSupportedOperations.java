...
public class ManoServiceInterfaceSupportedOperations   {
  ...
  **/
  @Schema(description= "Maximum number of concurrent requests supported by the interface operation.  NOTE: If this attribute is not present, the value of this parameter  is undefined. Overload is handled by the error handling schemes defined  by the applicable API specification. " )
