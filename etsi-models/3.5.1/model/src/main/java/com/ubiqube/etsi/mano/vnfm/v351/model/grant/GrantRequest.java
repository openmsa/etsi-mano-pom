 ...
 * defined in table 9.5.2.2-1. NOTE 1: The VNF LCM operations
 ...
 * granting request is for InstantiateVNF, either instantiationLevel or
 * addResources shall be present. NOTE 3: The NFVO will assume that the VNFM
 * will be responsible to both allocate and release the temporary resource
 * during the runtime of the LCM operation. This means, the resource can be
 * allocated and consumed after the \&quot;start\&quot; notification for the LCM
 * operation is sent by the VNFM, and the resource will be released before the
 * \&quot;result\&quot; notification of the VNF LCM operation is sent by the
 * VNFM. NOTE 4: The affinity/anti-affinity rules defined in the VNFD and the
 * placement constraints in the GrantVnfLifecycleOperation as defined in this
 * clause should be conflict-free. In case of conflicts, the placement
 * constraints in the GrantVnfLifecycleOperation shall take precedence. NOTE 5:
 * Passing constraints allows the VNFM or the lifecycle management scripts to
