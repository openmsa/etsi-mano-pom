 ...
 * of multiple VIMs per VNF. However, due to the partial support of this feature
 * in the present release, it is recommended in the present document that the
 * number of entries in the \&quot;vims\&quot; attribute in the Grant is not
 * greater than 1. NOTE 2: Void. NOTE 3: The Grant response allows the NFVO to
 * pass to the VNFM VIM assets related to the VNF package that is identified by
 * the vnfdId attribute in the corresponding Grant request. The NFVO may send in
 * each Grant response the full set of VIM assets related to the VNF package
 * defined by the vnfdId in the related Grant request, but shall send this
 * information if the vnfdId in the related Grant request differs from the
 * vnfdId passed in the previous Grant request, or if the Grant response is
 * related to an InstantiateVnf operation. The set of VIM assets shall not
 * change between subsequent Grant responses if the vnfdId has not changed.
 * During each LCM operation occurrence, the VIM assets that relate to the VNF
 * package identified by the current value of the vnfdId attribute in the
 * \&quot;VnfInstance\&quot; structure shall be used by the VNFM for newly
 * created resources. If the VNF package identifier of the VNF instance has been
 ...
 * resources. NOTE 4: The indication of externally-managed internal VLs is
 ...
 * are managed by the NFVO and created towards the VIM. NOTE 5: For any VNF
 * lifecycle management operation request that allows to pass
 ...
 * \&quot;extManagedVirtualLinks\&quot; attributes in the Grant otherwise. NOTE
 * 6: The NFVO shall set the value of the attribute by copying the value from
 * the associated GrantRequest. NOTE 7: In case of granting an InstantiateVnf
 * request that has originated from the NFVO and that did not contain the
...
public class Grant {
	 ...
	 * connections. The VNFM shall update the \"vimConnectionInfo\" attribute of the
	 ...
	 * information was configured to the VNFM in another way, present otherwise. See
	 * note 1.
	 *
	 ...
	 * Shall be set when resources are approved to be added and shall contain the
	 * same set of resources requested to be added in the related GrantRequest.
	 *
	 * @return addResources
	 **/
	@Schema(description = "List of resources that are approved to be added, with one entry per resource. Shall be set when resources are approved to be added and  shall contain the same set of resources requested to be added in the  related GrantRequest. ")
	@Valid
	 ...
	 * when resources are approved to be temporarily instantiated and shall contain
	 * the same set of resources requested to be temporarily instantiated in the
	 ...
	 * contain the same set of resources requested to be removed in the related
	 * GrantRequest.
	 *
	 * @return removeResources
	 **/
	@Schema(description = "List of resources that are approved to be removed, with one entry per resource. Shall be set when resources are approved to be removed and shall contain the same set of resources requested to be removed  in the related GrantRequest. ")
	@Valid
	 ...
	 * resource. Shall be set when resources are approved to be updated and shall
	 * contain the same set of resources requested to be updated in the related
	 * GrantRequest.
	 *
	 * @return updateResources
	 **/
	@Schema(description = "List of resources that are approved to be modified, with one entry per resource. Shall be set when resources are approved to be updated and shall contain the same set of resources requested to be updated  in the related GrantRequest. ")
	@Valid
	...
	/**
	 * Information about external VLs to connect the VNF to. See notes 5 and 7. If
	 * this attribute is present according to note 5 or note 7, it need not contain
	 * those entries that are unchanged compared to the entries that were passed in
	 * the LCM operation which is related to this granting exchange.
	 *
	 * @return extVirtualLinks
	 **/
	@Schema(description = "Information about external VLs to connect the VNF to. See notes 5 and 7. If this attribute  is present according to note 5 or note 7, it need not contain those entries that are unchanged  compared to the entries that were passed in the LCM operation which is related to this granting exchange. ")
	@Valid
	 ...
	 * VNFM. See notes 4, 5 and 7.
	 *
	 * @return extManagedVirtualLinks
	 **/
	@Schema(description = "Information about internal VLs that are managed by other entities than the VNFM. See notes 4, 5 and 7. ")
	@Valid
