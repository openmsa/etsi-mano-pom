...
import com.ubiqube.etsi.mano.nfvo.v351.model.nslcm.Mask;
import com.ubiqube.etsi.mano.nfvo.v351.model.nslcm.PortRange;
...
public class NfpRule  implements AnyOfNfpRule {
  ...
  /**
   * Indicates the protocol carried over the Ethernet layer. Permitted values: - IPV4 - IPV6 See note. 
   */
  ...
  /**
   * Indicates the L4 protocol, For IPv4 this corresponds to the field called \"Protocol\" to identify the next level protocol. For IPv6 this corresponds to the field is called the \"Next Header\" field. Permitted values: Any keyword defined in the IANA protocol registry, e.g.: TCP UDP ICMP See note. 
   */
   ...
   * @return etherType
   **/
  @Schema(description = "Indicates the protocol carried over the Ethernet layer. Permitted values: - IPV4 - IPV6 See note. ")
  ...
  /**
   * Indicates a VLAN identifier in an IEEE 802.1Q-2018 tag Multiple tags can be included for QinQ stacking. See note. 
   * @return vlanTag
   **/
  @Schema(description = "Indicates a VLAN identifier in an IEEE 802.1Q-2018 tag Multiple tags can be included for QinQ stacking. See note. ")
   ...
   * @return protocol
   **/
  @Schema(description = "Indicates the L4 protocol, For IPv4 this corresponds to the field called \"Protocol\" to identify the next level protocol. For IPv6 this corresponds to the field is called the \"Next Header\" field. Permitted values: Any keyword defined in the IANA protocol registry, e.g.: TCP UDP ICMP See note. ")
  ...
  /**
   * For IPv4 a string of \"0\" and \"1\" digits that corresponds to the 6-bit Differentiated Services Code Point (DSCP) field of the IP header. For IPv6 a string of \"0\" and \"1\" digits that corresponds to the 6 differentiated services bits of the traffic class header field. See note. 
   * @return dscp
   **/
  @Schema(description = "For IPv4 a string of \"0\" and \"1\" digits that corresponds to the 6-bit Differentiated Services Code Point (DSCP) field of the IP header. For IPv6 a string of \"0\" and \"1\" digits that corresponds to the 6 differentiated services bits of the traffic class header field. See note. ")
  ...
  /**
   * Indicates values of specific bits in a frame. See note. 
   * @return extendedCriteria
   **/
  @Schema(description = "Indicates values of specific bits in a frame. See note. ")
      @Valid
