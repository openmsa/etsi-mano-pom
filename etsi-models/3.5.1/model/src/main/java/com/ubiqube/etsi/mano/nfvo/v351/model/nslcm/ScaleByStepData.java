 ...
 * NOTE: A scaling step is the smallest unit by which a VNF instance can be
 * scaled w.r.t a particular scaling aspect.
 */
...
public class ScaleByStepData {
	 ...
	 * for all instances of a particular VNF. See note.
	 *
