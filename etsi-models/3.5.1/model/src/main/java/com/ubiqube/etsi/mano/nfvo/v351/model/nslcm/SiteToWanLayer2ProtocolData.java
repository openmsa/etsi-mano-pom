...
import com.ubiqube.etsi.mano.nfvo.v351.model.nslcm.SiteToWanLayer2ProtocolDataForwardingConfig;
import com.ubiqube.etsi.mano.nfvo.v351.model.nslcm.SiteToWanLayer2ProtocolDataLayer2ConnectionInfo;
import com.ubiqube.etsi.mano.nfvo.v351.model.nslcm.SiteToWanLayer2ProtocolDataVirtualRoutingAndForwarding;
 ...
 */
@Schema(description = "This type provides information about Layer 2 protocol specific information for the configuration of the NFVI-PoP network gateway to enable the stitching of the intra-site VN to the MSCS over the WAN. It shall comply with the provisions defined in Table 6.5.3.85-1. NOTE: Either \"networkResources\" or \"vnSegmentsIds\" shall be provided, but not both. ")
@Validated
