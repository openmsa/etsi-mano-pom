...
/**
 * This type represents modifications to a capacity threshold. It shall comply
 * with the provisions defined in table 10.5.2.8-1. NOTE: At least one of the
...
public class CapacityThresholdModifications {
	...
	public CapacityThresholdModifications callbackUri(final String callbackUri) {
	...
	public CapacityThresholdModifications authentication(final SubscriptionAuthentication authentication) {
	...
	public boolean equals(final java.lang.Object o) {
		...
		final CapacityThresholdModifications capacityThresholdModifications = (CapacityThresholdModifications) o;
