...
public class VnfSubscriptions351Sol003Controller implements VnfSubscriptions351Sol003Api {
	...
	public ResponseEntity<List<PkgmSubscription>> subscriptionsGet(final String filter, final String nextpageOpaqueMarker) {
		return vnfSubscriptionSol03FrontController.search(filter, PkgmSubscription.class, VnfSubscriptions351Sol003Controller::makeLinks);
	}
	...
	public ResponseEntity<PkgmSubscription> subscriptionsPost(final PkgmSubscriptionRequest subscriptionsPostQuery) {
		return vnfSubscriptionSol03FrontController.create(subscriptionsPostQuery, PkgmSubscription.class, VnfSubscriptions351Sol003Controller::makeLinks);
	}
	...
	public ResponseEntity<PkgmSubscription> subscriptionsSubscriptionIdGet(final String subscriptionId) {
		return vnfSubscriptionSol03FrontController.findById(subscriptionId, PkgmSubscription.class, VnfSubscriptions351Sol003Controller::makeLinks);
	}
