 ...
 */
@RestController
public class NsLcmOpOccs351Sol005Controller implements NsLcmOpOccs351Sol005Api {

	private final NsLcmGenericFrontController nsLcmGenericFrontController;

	public NsLcmOpOccs351Sol005Controller(final NsLcmGenericFrontController nsLcmGenericFrontController) {
		super();
	...
	public ResponseEntity<String> nsLcmOpOccsGet(final MultiValueMap<String, String> requestParams, final String nextpageOpaqueMarker) {
		return nsLcmGenericFrontController.search(requestParams, NsLcmOpOcc.class, nextpageOpaqueMarker, NsLcmOpOccs351Sol005Controller::makeLinks);
	}
	...
	public ResponseEntity<NsLcmOpOcc> nsLcmOpOccsNsLcmOpOccIdGet(final String nsLcmOpOccId) {
		return nsLcmGenericFrontController.findById(nsLcmOpOccId, NsLcmOpOcc.class, NsLcmOpOccs351Sol005Controller::makeLinks);
	}
