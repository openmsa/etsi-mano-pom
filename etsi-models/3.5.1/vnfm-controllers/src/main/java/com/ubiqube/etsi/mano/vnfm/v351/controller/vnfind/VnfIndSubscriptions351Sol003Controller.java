...
public class VnfIndSubscriptions351Sol003Controller implements VnfIndSubscriptions351Sol003Api {
	...
	public ResponseEntity<VnfIndicatorSubscription> indicatorsSubscriptionsSubscriptionIdGet(final String subscriptionId) {
		return subscriptionService.findById(subscriptionId, VnfIndicatorSubscription.class, VnfIndSubscriptions351Sol003Controller::makeLinks, SubscriptionType.VNFIND);
	}
