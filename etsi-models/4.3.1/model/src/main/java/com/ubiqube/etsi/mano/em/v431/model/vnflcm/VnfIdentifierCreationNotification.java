...
public class VnfIdentifierCreationNotification   {
  ...
  public VnfIdentifierCreationNotification id(String id) {
    this.id = id;
    return this;
  }
  ...
  public VnfIdentifierCreationNotification notificationType(NotificationTypeEnum notificationType) {
  ...
  public VnfIdentifierCreationNotification subscriptionId(String subscriptionId) {
  ...
  public VnfIdentifierCreationNotification timeStamp(OffsetDateTime timeStamp) {
  ...
  public VnfIdentifierCreationNotification vnfInstanceId(String vnfInstanceId) {
  ...
  public VnfIdentifierCreationNotification _links(LccnLinks _links) {
    this._links = _links;
    return this;
  }
