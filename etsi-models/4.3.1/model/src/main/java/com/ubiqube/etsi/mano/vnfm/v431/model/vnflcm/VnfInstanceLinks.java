...
public class VnfInstanceLinks {
	...
	@JsonProperty("changeCurrentVnfPkg")
	private Link changeCurrentVnfPkg = null;
	...
	public VnfInstanceLinks changeCurrentVnfPkg(final Link changeCurrentVnfPkg) {
		this.changeCurrentVnfPkg = changeCurrentVnfPkg;
		return this;
	}

	/**
	 * Get changeCurrentVnfPkg
	 *
	 * @return changeCurrentVnfPkg
	 **/
	@Schema(description = "")

	@Valid
	public Link getChangeCurrentVnfPkg() {
		return changeCurrentVnfPkg;
	}

	public void setChangeCurrentVnfPkg(final Link changeCurrentVnfPkg) {
		this.changeCurrentVnfPkg = changeCurrentVnfPkg;
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.self, vnfInstanceLinks.self) &&
				...
				Objects.equals(this.changeCurrentVnfPkg, vnfInstanceLinks.changeCurrentVnfPkg);
	}

	@Override
	public int hashCode() {
		return Objects.hash(self, indicators, instantiate, terminate, scale, scaleToLevel, changeFlavour, heal, operate, changeExtConn, createSnapshot, revertToSnapshot, changeCurrentVnfPkg);
	}
	...
	public String toString() {
		...
		sb.append("    changeCurrentVnfPkg: ").append(toIndentedString(changeCurrentVnfPkg)).append("\n");
		sb.append("}");
		return sb.toString();
	}
