...
import com.ubiqube.etsi.mano.nfvo.v431.model.nsfm.AlarmClearedNotificationLinks;
 ...
 */
@Schema(description = "This type represents an alarm cleared notification about NS faults. It shall comply with the provisions defined in Table 8.5.2.6-1. The notification shall be triggered by the NFVO when an alarm has been cleared. ")
@Validated
...
public class AlarmClearedNotification   {
  ...
  private Object alarmClearedTime = null;
  ...
  public AlarmClearedNotification alarmClearedTime(Object alarmClearedTime) {
  ...
  @Schema(required = true, description = "The time stamp indicating when the alarm was cleared. ")
    ...
    public Object getAlarmClearedTime() {
    return alarmClearedTime;
  }

  public void setAlarmClearedTime(Object alarmClearedTime) {
    this.alarmClearedTime = alarmClearedTime;
  }
