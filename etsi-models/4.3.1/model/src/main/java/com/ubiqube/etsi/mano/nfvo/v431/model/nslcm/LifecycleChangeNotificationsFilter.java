 ...
 * one filter attribute). NOTE: The permitted values of the
...
public class LifecycleChangeNotificationsFilter {
	...
	@Valid
	private List<NsLcmOperationStateType> operationStates = null;

	@JsonProperty("affectedNsInstanceIds")
	@Valid
	private List<String> affectedNsInstanceIds = null;
	 ...
	 * NsIdentifierDeletionNotification - NsLcmCapacityShortageNotification -
	 * NsChangeNotification See note.
	 *
	 * @return notificationTypes
	 **/
	@Schema(description = "Match particular notification types. Permitted values: - NsLcmOperationOccurrenceNotification - NsIdentifierCreationNotification - NsIdentifierDeletionNotification - NsLcmCapacityShortageNotification - NsChangeNotification See note. ")
	...
	public LifecycleChangeNotificationsFilter operationStates(final List<NsLcmOperationStateType> operationStates) {
		this.operationStates = operationStates;
		return this;
	}

	public LifecycleChangeNotificationsFilter addOperationStatesItem(final NsLcmOperationStateType operationStatesItem) {
	...
	@Valid
	public List<NsLcmOperationStateType> getOperationStates() {
		return operationStates;
	}

	public void setOperationStates(final List<NsLcmOperationStateType> operationStates) {
		this.operationStates = operationStates;
	}

	public LifecycleChangeNotificationsFilter affectedNsInstanceIds(final List<String> affectedNsInstanceIds) {
		this.affectedNsInstanceIds = affectedNsInstanceIds;
		return this;
	}

	public LifecycleChangeNotificationsFilter addAffectedNsInstanceIdsItem(final String affectedNsInstanceIdsItem) {
		if (this.affectedNsInstanceIds == null) {
			this.affectedNsInstanceIds = new ArrayList<>();
		}
		this.affectedNsInstanceIds.add(affectedNsInstanceIdsItem);
		return this;
	}

	/**
	 * Match particular identifiers of the NS instance(s) related to the operation
	 * occurrence that were affected by the shortage as reported in notifications of
	 * type NsLcmCapacityShortageNotification. May be present if the
	 * \"notificationTypes\" attribute contains the value
	 * \"NsLcmCapacityShortageNotification\", and shall be absent otherwise.
	 *
	 * @return affectedNsInstanceIds
	 **/
	@Schema(description = "Match particular identifiers of the NS instance(s) related to the operation occurrence that were affected by the shortage as reported in notifications of type NsLcmCapacityShortageNotification. May be present if the \"notificationTypes\" attribute contains the value \"NsLcmCapacityShortageNotification\", and shall be absent otherwise. ")

	public List<String> getAffectedNsInstanceIds() {
		return affectedNsInstanceIds;
	}

	public void setAffectedNsInstanceIds(final List<String> affectedNsInstanceIds) {
		this.affectedNsInstanceIds = affectedNsInstanceIds;
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.nsInstanceSubscriptionFilter, lifecycleChangeNotificationsFilter.nsInstanceSubscriptionFilter) &&
				...
				Objects.equals(this.affectedNsInstanceIds, lifecycleChangeNotificationsFilter.affectedNsInstanceIds) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash(nsInstanceSubscriptionFilter, notificationTypes, operationTypes, operationStates, affectedNsInstanceIds, nsComponentTypes, lcmOpNameImpactingNsComponent, lcmOpOccStatusImpactingNsComponent);
	}
	...
	public String toString() {
		...
		sb.append("    affectedNsInstanceIds: ").append(toIndentedString(affectedNsInstanceIds)).append("\n");
