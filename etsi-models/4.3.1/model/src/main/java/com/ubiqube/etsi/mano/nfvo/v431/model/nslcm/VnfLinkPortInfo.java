 ...
 * with the provisions defined in table 6.5.3.64-1. NOTE 1: Either cpInstanceId
 * with cpInstanceType set to \&quot;EXT_CP\&quot; or any combination of
 * cpInstanceId with cpInstanceType set to \&quot;VNFC_CP\&quot; and
 * vipCpInstanceId (i.e. one or both of them) shall be present for a
...
public class VnfLinkPortInfo {
	 ...
	 * port is associated to an external CP. See note 1.
	 */
