...
/**
 * This type represents an NS lifecycle management operation occurrence
 * notification, which informs the receiver of changes in the NS lifecycle
 * caused by an NS LCM operation occurrence. The NS LCM operation occurrence may
 * be triggered by the OSS/BSS or automatically triggered by the NFVO.
 */
@Schema(description = "This type represents an NS lifecycle management operation occurrence notification, which informs the receiver of changes in the NS lifecycle caused by an NS LCM operation occurrence. The NS LCM operation occurrence may be triggered by the OSS/BSS or automatically triggered by the NFVO.")
@Validated
...
public class NsLcmOperationOccurrenceNotification {
	...
	@JsonProperty("feasibilityCheckResult")
	private FeasibilityCheckResultType feasibilityCheckResult = null;
	 ...
	 * @return affectedVnf
	 **/
	@Schema(description = "Information about the VNF instances that were affected during the lifecycle operation. See note 1. ")
	@Valid
	 ...
	 * @return affectedPnf
	 **/
	@Schema(description = "Information about the PNF instances that were affected during the lifecycle operation. See note 1. ")
	@Valid
	 ...
	 * @return affectedVl
	 **/
	@Schema(description = "Information about the VL instances that were affected during the lifecycle operation. See note 1. ")
	@Valid
	 ...
	 **/
	@Schema(description = "Information about the VNFFG instances that were affected during the lifecycle operation. See note 1.  ")
	@Valid
	 ...
	 * @return affectedNs
	 **/
	@Schema(description = "Information about the SAP instances that were affected during the lifecycle operation.See note 1. ")
	@Valid
	...
	public NsLcmOperationOccurrenceNotification feasibilityCheckResult(final FeasibilityCheckResultType feasibilityCheckResult) {
		this.feasibilityCheckResult = feasibilityCheckResult;
		return this;
	}

	/**
	 * Get feasibilityCheckResult
	 *
	...
	@Valid
	public FeasibilityCheckResultType getFeasibilityCheckResult() {
		return feasibilityCheckResult;
	}

	public void setFeasibilityCheckResult(final FeasibilityCheckResultType feasibilityCheckResult) {
		this.feasibilityCheckResult = feasibilityCheckResult;
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.id, nsLcmOperationOccurrenceNotification.id) &&
				...
				Objects.equals(this.feasibilityCheckResult, nsLcmOperationOccurrenceNotification.feasibilityCheckResult) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, nsInstanceId, nsLcmOpOccId, operation, notificationType, subscriptionId, timestamp, notificationStatus, operationState, isAutomaticInvocation, verbosity, affectedVnf, affectedPnf, affectedVl, affectedVnffg, affectedNs, affectedSap, feasibilityCheckResult, error, _links);
	}
	...
	public String toString() {
		...
		sb.append("    feasibilityCheckResult: ").append(toIndentedString(feasibilityCheckResult)).append("\n");
