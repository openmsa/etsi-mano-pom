 ...
 * VNFCs. NOTE: The \&quot;resourceDefinitionId\&quot; attribute provides
 * information to the API consumer (i.e. the NFVO) to assist in correlating the
 * resource changes performed during the LCM operation with the granted
 * resources in a specific Grant exchange, which is identified by the
 * \&quot;grantId\&quot; available in the \&quot;Individual VNF lifecycle
 * management operation occurrence\&quot; and the \&quot;id\&quot; in the
 * \&quot;Individual Grant\&quot;.
 */
@Schema(description = "This type provides information about added, deleted, modified and temporary VNFCs. NOTE: The \"resourceDefinitionId\" attribute provides information to the API consumer        (i.e. the NFVO) to assist in correlating the resource changes performed during        the LCM operation with the granted resources in a specific Grant exchange, which        is identified by the \"grantId\" available in the \"Individual VNF lifecycle management        operation occurrence\" and the \"id\" in the \"Individual Grant\". ")
@Validated
