...
import com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.WanConnectionDataNsVirtualLink;
import com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.WanConnectionDataVnfVirtualLink;
import com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.WanConnectionProtocolData;
...
/**
 * This type provides information used to connect the comprising network resources realizing a VL, e.g., when the VL is deployed on several sites and across a WAN. It shall comply with the provisions defined in table 6.5.3.80-1. NOTE: Either a \&quot;nsVirtualLink\&quot; or a \&quot;vnfVirtualLink\&quot; shall be provided, but not both. 
 */
@Schema(description = "This type provides information used to connect the comprising network resources realizing a VL, e.g., when the VL is deployed on several sites and across a WAN. It shall comply with the provisions defined in table 6.5.3.80-1. NOTE: Either a \"nsVirtualLink\" or a \"vnfVirtualLink\" shall be provided, but not both. ")
@Validated
