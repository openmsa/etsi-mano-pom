...
public class ChangeExtVnfConnectivityRequest {
	 ...
	 * the related \"ExtVirtualLinkInfo\" informationknown to the VNFM represented
	 * in the \"VnfInstance\" structure (see clause 5.5.2.2) and the related
	 * overriding information provided in the \"Grant\" structure (see clause
	 * 9.5.2.3): Even if the VNF is not in fully scaled-out state, the API consumer
	 * shall provide enough CP configuration records to allow connecting the VNF
	...
	public ChangeExtVnfConnectivityRequest vimConnectionInfo(final Map<String, VimConnectionInfo> vimConnectionInfo) {
		this.vimConnectionInfo = vimConnectionInfo;
		return this;
	}

	public ChangeExtVnfConnectivityRequest putVimConnectionInfoItem(final String key, final VimConnectionInfo vimConnectionInfoItem) {
