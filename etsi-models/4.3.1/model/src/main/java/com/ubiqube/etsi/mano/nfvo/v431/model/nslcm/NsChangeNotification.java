...
/**
 * This type represents an NS change notification, which informs the receiver of
 * changes on an NS instance caused by an LCM operation occurrence, which
 * directly or indirectly impacts its NS component and is triggered without any
 * context of this NS instance.
 */
@Schema(description = "This type represents an NS change notification, which informs the receiver of changes on an NS instance caused by an LCM operation occurrence, which directly or indirectly impacts its NS component and is triggered without any context of this NS instance.")
@Validated
