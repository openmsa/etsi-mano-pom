...
import com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.AffectedNs;
import com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.AffectedPnf;
import com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.AffectedSap;
import com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.AffectedVirtualLink;
import com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.AffectedVnf;
import com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.AffectedVnffg;
...
public class NsLcmOpOccResourceChanges   {
   ...
   * @return affectedVnfs
   **/
  @Schema(description = "Information about the VNF instances that were affected during the lifecycle operation, if this notification represents the result of a lifecycle operation. See note 1. ")
      @Valid
   ...
   * @return affectedPnfs
   **/
  @Schema(description = "Information about the PNF instances that were affected during the lifecycle operation, if this notification represents the result of a lifecycle operation. See note 1. ")
      @Valid
   ...
   * @return affectedVls
   **/
  @Schema(description = "Information about the VL instances that were affected during the lifecycle operation, if this notification represents the result of a lifecycle operation. See note 1. ")
      @Valid
   ...
   **/
  @Schema(description = "Information about the VNFFG instances that were affected during the lifecycle operation, if this notification represents the result of a lifecycle operation. See note 1. ")
      @Valid
   ...
   * @return affectedNss
   **/
  @Schema(description = "Information about the nested NS instances that were affected during the lifecycle operation, if this notification represents the result of a lifecycle operation. See note 1. ")
      @Valid
