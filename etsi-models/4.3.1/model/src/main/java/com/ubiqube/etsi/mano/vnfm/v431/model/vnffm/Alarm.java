 ...
 */
package com.ubiqube.etsi.mano.vnfm.v431.model.vnffm;
...
import com.ubiqube.etsi.mano.vnfm.v431.model.vnffm.EventType;
import com.ubiqube.etsi.mano.vnfm.v431.model.vnffm.FaultyResourceInfo;
import com.ubiqube.etsi.mano.vnfm.v431.model.vnffm.PerceivedSeverityType;
...
public class Alarm   {
  ...
  /**
   * Additional information to clarify the type of the fault. If the alarm is related to changes in the state of virtualised resources  due to NFVI operation and maintenance, this attribute shall be set to  \"NFVI_OAM_VIRTUALISED_RESOURCE_STATE_CHANGE\". 
   * @return faultType
   **/
  @Schema(description = "Additional information to clarify the type of the fault. If the alarm is related to changes in the state of virtualised resources  due to NFVI operation and maintenance, this attribute shall be set to  \"NFVI_OAM_VIRTUALISED_RESOURCE_STATE_CHANGE\". ")
