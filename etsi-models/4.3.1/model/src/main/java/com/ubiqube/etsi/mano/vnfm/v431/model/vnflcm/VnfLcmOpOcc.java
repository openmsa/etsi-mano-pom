...
/**
 * This type represents a VNF lifecycle management operation occurrence. NOTE 1:
 ...
 * or a wrongly configured subscription filter. NOTE 2: Not more than one of
 * changedInfo and modificationsTriggeredByVnfPkgChange shall be present. NOTE
 * 3: For a particular affected VL, there shall be as many
...
public class VnfLcmOpOcc implements OneOfVnfLcmOpOcc {
	...
	public VnfLcmOpOcc addLcmCoordinationsItem(final VnfLcmOpOccLcmCoordinations lcmCoordinationsItem) {
	...
	/**
	 * Information about LCM coordination actions (see clause 10 in ETSI GS
	 * NFV-SOL002) related to this LCM operation occurrence.
	 *
	 * @return lcmCoordinations
	 **/
	@Schema(description = "Information about LCM coordination actions (see clause 10 in ETSI GS NFV-SOL002) related to this LCM operation occurrence. ")
	@Valid
	...
	public VnfLcmOpOcc addRejectedLcmCoordinationsItem(final VnfLcmOpOccRejectedLcmCoordinations rejectedLcmCoordinationsItem) {
	...
	/**
	 * Information about LCM coordination actions (see clause 10 in ETSI GS
	 * NFV-SOL002) that were rejected by 503 error which means they can be tried
	 * again after a delay. See note 5.
	 *
	 * @return rejectedLcmCoordinations
	 **/
	@Schema(description = "Information about LCM coordination actions (see clause 10 in ETSI GS NFV-SOL002) that were rejected by 503 error which means they can be tried again after a delay. See note 5. ")
	@Valid
