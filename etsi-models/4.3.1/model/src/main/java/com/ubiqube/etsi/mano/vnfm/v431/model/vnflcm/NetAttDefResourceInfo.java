...
/**
 * This type contains information related to a network attachment definition
 * resource that provides the specification of the interface used to connect one
 * or multiple connection points to a secondary container cluster network.
 */
...
public class NetAttDefResourceInfo {
	 ...
	 * definition resource. Shall be present when the network attachment definition
	 * resource is used for external connectivity by the VNF.
	 *
	...
	/**
	 * Identifier of the VNFC CP associated to this network attachment definition
	 * resource. May be present when the network attachment definition resource is
	 * used for internal connectivity by the VNF.
	 *
