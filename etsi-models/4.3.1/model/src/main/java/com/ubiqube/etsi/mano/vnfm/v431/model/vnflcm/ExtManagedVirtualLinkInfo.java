...
public class ExtManagedVirtualLinkInfo {
	...
	public ExtManagedVirtualLinkInfo addVnfNetAttDefResourceItem(final NetAttDefResourceInfo vnfNetAttDefResourceItem) {
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, vnfVirtualLinkDescId, vnfdId, networkResource, vnfLinkPorts, vnfNetAttDefResource, extManagedMultisiteVirtualLinkId);
	}
