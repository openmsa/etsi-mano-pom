...
public class VnfLcmOpOccResourceChanges   {
  ...
  /**
   * Information about VL instances that were affected during the lifecycle operation.  See notes 1 and 3. 
   * @return affectedVirtualLinks
   **/
  @Schema(description = "Information about VL instances that were affected during the lifecycle operation.  See notes 1 and 3. ")
      @Valid
