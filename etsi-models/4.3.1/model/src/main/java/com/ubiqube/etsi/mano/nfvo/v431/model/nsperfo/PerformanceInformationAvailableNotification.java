 ...
 */
package com.ubiqube.etsi.mano.nfvo.v431.model.nsperfo;

import java.util.Objects;
import com.fasterxml.jackson.annotation.JsonProperty;
import com.fasterxml.jackson.annotation.JsonCreator;
import com.ubiqube.etsi.mano.nfvo.v431.model.nsperfo.PerformanceInformationAvailableNotificationLinks;
...
/**
 * This notification informs the receiver that performance information is available. The notification shall be triggered by the NFVO when new performance information  collected by a PM job is available. The periodicity of triggering this notification is influenced by the \&quot;reportingPeriod\&quot; attribute in the \&quot;PmJobCriteria\&quot; data structure as defined in clause 7.5.3.3. 
 */
@Schema(description = "This notification informs the receiver that performance information is available. The notification shall be triggered by the NFVO when new performance information  collected by a PM job is available. The periodicity of triggering this notification is influenced by the \"reportingPeriod\" attribute in the \"PmJobCriteria\" data structure as defined in clause 7.5.3.3. ")
@Validated
...
public class PerformanceInformationAvailableNotification   {
  ...
  public PerformanceInformationAvailableNotification notificationType(String notificationType) {
