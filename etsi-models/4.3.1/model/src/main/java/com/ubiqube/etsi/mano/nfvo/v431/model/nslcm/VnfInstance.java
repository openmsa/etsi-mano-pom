...
public class VnfInstance {
	...
	public VnfInstance versionDependency(final List<VersionDependency> versionDependency) {
		this.versionDependency = versionDependency;
		return this;
	}

	public VnfInstance addVersionDependencyItem(final VersionDependency versionDependencyItem) {
	...
	/**
	 * Describes version dependencies currently valid for the VNF instance.
	 * Identifies versions of descriptors of other constituents in the NSD upon
	 * which the VNF depends. The dependencies may be described for the VNFD
	 * referenced in this VnfInfo with vnfdId and for VNFDs with the same
	 * VnfdExtInvariantId. There shall not be more than one versionDependency
	 * present with the same dependentConstituentId.
	 *
