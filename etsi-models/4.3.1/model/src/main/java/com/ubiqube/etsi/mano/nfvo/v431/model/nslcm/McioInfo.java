 ...
 * based on the same VDU. NOTE 1 The type of MCIO as specified in the
 * declarative descriptor of the MCIO, and that can be read from the CISM.
 * EXAMPLE: In case of MCIOs managed by Kubernetes, the type of MCIO corresponds
 * to the “kind” property of the declarative descriptor. NOTE 2 If the attribute
 * additionalInfo is present, it may contain runtime information on the actual
 * and desired state of the MCIO(s). NOTE 3 When the container infrastructure
 * service is a Kubernetes® instance, the mcioId is the combined values from the
 * kind and name fields of the Kubernetes® resource object, separated by a
 * slash. Example: \&quot;Deployment/abcd\&quot;. NOTE 4 When the container
 * infrastructure service is a Kubernetes® instance, the mcioName is the name
...
public class McioInfo {
	...
	/**
	 * The type of MCIO. Specific values, their semantics and associated MCIO types
	 * are defined in clause 6.5.4.13. Additional values are also permitted. See
	 * note 1.
	 *
	 * @return mcioType
	 **/
