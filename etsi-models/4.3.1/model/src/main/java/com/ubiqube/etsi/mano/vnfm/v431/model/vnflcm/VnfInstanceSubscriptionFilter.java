...
import com.ubiqube.etsi.mano.vnfm.v431.model.vnflcm.VnfInstanceSubscriptionFilterVnfProductsFromProviders;
 ...
 */
@Schema(description = "This type represents subscription filter criteria to match VNF instances. * NOTE 1: The attributes \"vnfdIds\" and \"vnfProductsFromProviders\" are alternatives to reference to VNF instances           that are based on certain VNFDs in a filter. They should not be used both in the same filter instance,           but one alternative should be chosen.   NOTE 2: The attributes \"vnfInstanceIds\" and \"vnfInstanceNames\" are alternatives to reference to particular VNF           instances in a filter. They should not be used both in the same filter instance, but one alternative           should be chosen. ")
@Validated
...
public class VnfInstanceSubscriptionFilter  implements AnyOfVnfInstanceSubscriptionFilter {
  ...
  /**
   * If present, match VNF instances that were created based on a VNFD identified by one of the vnfdId values listed in this attribute. See note 1. 
   * @return vnfdIds
   **/
  @Schema(description = "If present, match VNF instances that were created based on a VNFD identified by one of the vnfdId values listed in this attribute. See note 1. ")
   ...
   **/
  @Schema(description = "If present, match VNF instances that belong to VNF products from certain providers. See note 1. ")
      @Valid
   ...
   **/
  @Schema(description = "If present, match VNF instances with an instance identifier listed in this attribute. See note 2. ")
   ...
   **/
  @Schema(description = "If present, match VNF instances with a VNF Instance Name listed in this attribute. See note 2. ")
