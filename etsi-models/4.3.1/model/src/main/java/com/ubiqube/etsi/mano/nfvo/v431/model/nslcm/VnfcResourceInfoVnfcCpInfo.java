...
public class VnfcResourceInfoVnfcCpInfo {
	 ...
	 * exposed as an external CP. See note 3.
	 *
	 * @return cpProtocolInfo
	 **/
	@Schema(description = "Network protocol information for this CP. May be omitted if the VNFC CP is exposed as an external CP. See note 3. ")
	@Valid
	 ...
	 * container cluster network. See notes 4 and 5. It shall be present if the
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, cpdId, vnfExtCpId, cpProtocolInfo, parentCpId, vnfLinkPortId, netAttDefResourceId, metadata);
	}
