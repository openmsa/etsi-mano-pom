...
import com.ubiqube.etsi.mano.vnfm.v431.model.vnfind.VnfIndicatorValueChangeNotificationLinks;
...
/**
 * This type represents a VNF indicator value change notification. The notification shall be triggered by the VNFM when the value of an indicator has changed. NOTE: ETSI GS NFV-SOL 001 specifies the structure and format of the VNFD based on TOSCA specifications. 
 */
@Schema(description = "This type represents a VNF indicator value change notification. The notification shall be triggered by the VNFM when the value of an indicator has changed. NOTE: ETSI GS NFV-SOL 001 specifies the structure and format of the VNFD based on TOSCA specifications. ")
@Validated
...
public class VnfIndicatorValueChangeNotification   {
   ...
   * @return value
   **/
  @Schema(required = true, description = "Provides the value of the VNF indicator. The value format is defined in the VNFD. See note. ")
      @NotNull
