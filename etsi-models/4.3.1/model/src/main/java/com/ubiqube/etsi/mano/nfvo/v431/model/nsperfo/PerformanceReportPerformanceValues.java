...
public class PerformanceReportPerformanceValues {
	 ...
	 * the related \"Measurement Unit\" as defined in clause 7.3 of ETSI GS NFV-IFA
	 * 027.
	 *
	 * @return value
	 **/
	@Schema(description = "Value of the metric collected. The type of this attribute shall correspond to the related \"Measurement Unit\" as defined in clause 7.3 of ETSI GS NFV-IFA 027. ")
