...
import com.ubiqube.etsi.mano.vnfm.v431.model.grant.IpOverEthernetAddressDataAddressRange;
...
public class IpOverEthernetAddressDataIpAddresses   {
  ...
  /**
   * Fixed addresses to assign (from the subnet defined by \"subnetId\" if provided). See note 2. 
   * @return fixedAddresses
   **/
  @Schema(description = "Fixed addresses to assign (from the subnet defined by \"subnetId\" if provided). See note 2. ")
  ...
  /**
   * Number of dynamic addresses to assign (from the subnet defined by \"subnetId\" if provided). See note 2. 
   * @return numDynamicAddresses
   **/
  @Schema(description = "Number of dynamic addresses to assign (from the subnet defined by \"subnetId\" if provided). See note 2. ")
