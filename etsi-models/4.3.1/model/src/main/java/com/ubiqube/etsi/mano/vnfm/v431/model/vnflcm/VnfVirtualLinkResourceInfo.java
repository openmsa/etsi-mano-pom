 ...
 * resource that is used by an internal VL instance in a VNF instance. Note: If
 * only the value or the presence of this attribute is changed in the
 * \&quot;VnfVirtualLinkResourceInfo\&quot; structure by an LCM operation
 * occurrence, this does not represent a change that requires including a
 * related \&quot;AffectedVirtualLink\&quot; structure in the VNF LCM operation
 * occurrence notifications or the \&quot;VnfLcmOpOcc\&quot; structure related
 * to this LCM operation occurrence.
 */
@Schema(description = "This type represents the information that allows addressing a virtualised resource that is used by an internal VL instance in a VNF instance. Note: If only the value or the presence of this attribute is changed in the \"VnfVirtualLinkResourceInfo\"       structure by an LCM operation occurrence, this does not represent a change that requires including       a related \"AffectedVirtualLink\" structure in the VNF LCM operation occurrence notifications or the       \"VnfLcmOpOcc\" structure related to this LCM operation occurrence. ")
@Validated
...
public class VnfVirtualLinkResourceInfo {
	...
	public VnfVirtualLinkResourceInfo zoneId(final String zoneId) {
		this.zoneId = zoneId;
		return this;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, vnfVirtualLinkDescId, vnfdId, networkResource, zoneId, reservationId, vnfLinkPorts, metadata);
	}
