...
public class IntVnfCpData   {
  ...
  @Valid
  private List<String> netAttDefResourceId = new ArrayList<>();
  ...
  public IntVnfCpData netAttDefResourceId(List<String> netAttDefResourceId) {
    this.netAttDefResourceId = netAttDefResourceId;
    return this;
  }

  public IntVnfCpData addNetAttDefResourceIdItem(String netAttDefResourceIdItem) {
    this.netAttDefResourceId.add(netAttDefResourceIdItem);
    return this;
  }

  /**
   * Identifiers of the “NetAttDefResourceData” structure that provides the specification of the interface to attach the VNF internal CP created from the CPD identified by cpdId to a secondary container cluster network. See note. 
   * @return netAttDefResourceId
   **/
  @Schema(required = true, description = "Identifiers of the “NetAttDefResourceData” structure that provides the specification of the interface to attach the VNF internal CP created from the CPD identified by cpdId to a secondary container cluster network. See note. ")
      @NotNull
