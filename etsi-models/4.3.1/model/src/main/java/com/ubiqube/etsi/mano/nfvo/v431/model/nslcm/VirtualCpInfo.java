...
/**
 * This type represents the information related to a virtual CP instance of a
 * VNF. NOTE: A consumer of the VNF LCM interface can learn the actual VNFC
 * instances implementing the service accessible via the virtual CP instance by
 * querying the \&quot;vnfcResourceInfo\&quot; from the
 * \&quot;InstantiatedVnfInfo\&quot; and filtering by corresponding
 * \&quot;vduId\&quot; values.
 */
@Schema(description = "This type represents the information related to a virtual CP instance of a VNF. NOTE: A consumer of the VNF LCM interface can learn the actual VNFC instances implementing the service accessible via the virtual CP instance by querying the \"vnfcResourceInfo\" from the \"InstantiatedVnfInfo\" and filtering by corresponding \"vduId\" values.")
@Validated
