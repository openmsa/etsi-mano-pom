 ...
 * structure that were modified implicitly during the operation. NOTE 1: This
 * attribute represents the delta (semantics as per IETF RFC 7396, JSON Merge
 * Patch) between the value of the attribute at the start of the \&quot;Change
 * current VNF package\&quot; operation and the value of the attribute at its
...
public class ModificationsTriggeredByVnfPkgChange {
	...
	public ModificationsTriggeredByVnfPkgChange vimConnectionInfo(final Map<String, VimConnectionInfo> vimConnectionInfo) {
		this.vimConnectionInfo = vimConnectionInfo;
		return this;
	}

	public ModificationsTriggeredByVnfPkgChange putVimConnectionInfoItem(final String key, final VimConnectionInfo vimConnectionInfoItem) {
	...
	/**
	 * If present, this attribute signals the changes to VIM connection info that
	 * were passed in the related \"ChangeCurrentVnfPkgRequest\" structure. The
	 * provisions for sensitive information defined in clause 4.4.1.6 apply.
	 *
	 * @return vimConnectionInfo
	 **/
	@Schema(description = "If present, this attribute signals the changes to VIM connection info that were passed in the related  \"ChangeCurrentVnfPkgRequest\" structure. The provisions for sensitive information defined in clause  4.4.1.6 apply. ")
	@Valid
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.vnfConfigurableProperties, modificationsTriggeredByVnfPkgChange.vnfConfigurableProperties) &&
				...
				Objects.equals(this.vimConnectionInfo, modificationsTriggeredByVnfPkgChange.vimConnectionInfo);
	}

	@Override
	public int hashCode() {
		return Objects.hash(vnfConfigurableProperties, metadata, extensions, vnfdId, vnfProvider, vnfProductName, vnfSoftwareVersion, vnfdVersion, vimConnectionInfo);
	}
