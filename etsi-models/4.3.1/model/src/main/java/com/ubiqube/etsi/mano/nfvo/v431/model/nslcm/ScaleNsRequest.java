...
import com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.ScaleNsData;
import com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.ScaleVnfData;
...
/**
 * This type represents a request for the scale NS operation. Either the parameter scaleNsData or the parameter scaleVnfData, but not both shall be provided NOTE: Either the parameter scaleNsData or the parameter scaleVnfData, but not both shall be provided. 
 */
@Schema(description = "This type represents a request for the scale NS operation. Either the parameter scaleNsData or the parameter scaleVnfData, but not both shall be provided NOTE: Either the parameter scaleNsData or the parameter scaleVnfData, but not both shall be provided. ")
@Validated
...
public class ScaleNsRequest  implements OneOfScaleNsRequest {
  ...
  /**
   * The necessary information to scale the referenced NS instance. It shall be present when scaleType = SCALE_VNF. See note. 
   * @return scaleVnfData
   **/
  @Schema(description = "The necessary information to scale the referenced NS instance. It shall be present when scaleType = SCALE_VNF. See note. ")
      @Valid
