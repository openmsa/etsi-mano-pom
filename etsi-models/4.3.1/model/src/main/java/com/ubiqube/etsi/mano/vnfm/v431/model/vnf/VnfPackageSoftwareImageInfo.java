 ...
 * was taken from \&quot;Container formats\&quot; in OpenStack® documentation:
 * \&quot;Disk and container formats for images\&quot; (Available at
 * https://docs.openstack.org/glance/pike/user/formats.html). * NOTE 2: The list
 * of permitted values was adapted from \&quot;Disk formats\&quot; in OpenStack®
 * documentation: \&quot;Disk and container formats for images\&quot; (Available
 * at https://docs.openstack.org/glance/pike/user/formats.html). * NOTE 3: The
 * attribute shall be present for VM-based software images referenced from a
 * Vdu, and shall be absent otherwise. * NOTE 4: The attribute shall be present
 * for software images referenced from a VirtualStorageDesc, and shall be absent
 * otherwise.
 */
...
public class VnfPackageSoftwareImageInfo {
	 ...
	 * @return diskFormat
	 **/
	@Schema(description = "Disk format of a software image is the format of the underlying disk image. Permitted values:   - AKI: a kernel image format   - AMI: a machine image format   - ARI: a ramdisk image format   - ISO: an archive format for the data contents of an optical disc,     such as CD-ROM   - QCOW2: a common disk image format, which can expand dynamically     and supports copy on write   - RAW: an unstructured disk image format   - VDI: a common disk image format   - VHD: a common disk image format   - VHDX: enhanced version of VHD format   - VMDK: a common disk image format See notes 2 and 3. ")
