...
import com.ubiqube.etsi.mano.em.v431.model.vnfind.SupportedIndicatorsChangeNotificationLinks;
import com.ubiqube.etsi.mano.em.v431.model.vnfind.SupportedIndicatorsChangeNotificationSupportedIndicators;
...
/**
 * This type represents a notification to inform the receiver that the set of indicators supported by a VNF instance has changed. *   NOTE: ETSI GS NFV-SOL 001 specifies the structure and           format of the VNFD based on TOSCA specifications. 
 */
@Schema(description = "This type represents a notification to inform the receiver that the set of indicators supported by a VNF instance has changed. *   NOTE: ETSI GS NFV-SOL 001 specifies the structure and           format of the VNFD based on TOSCA specifications. ")
@Validated
...
public class SupportedIndicatorsChangeNotification   {
  ...
  public SupportedIndicatorsChangeNotification notificationType(String notificationType) {
