 ...
 * VNFC: a) For a VNFC based on VM, storage resource identifiers shall refer to
 * VirtualStorage resources, and b) For a VNFC based on OS container(s), storage
 ...
 * directly to an external VL. NOTE 3: The information can be omitted because it
 * is already available as part of the external CP information. NOTE 4: If only
 * the value or the presence of this attribute is changed in the
 ...
 * build a link redundant mated pair in SR-IOV cases. NOTE 6: When more than one
...
public class VnfcResourceInfo {
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, vduId, vnfdId, computeResource, zoneId, storageResourceIds, reservationId, vnfcCpInfo, metadata);
	}
