...
import com.ubiqube.etsi.mano.vnfm.v431.model.vnflcm.IpOverEthernetAddressInfoAddressRange;
...
public class IpOverEthernetAddressInfoIpAddresses   {
   ...
   * @return addresses
   **/
  @Schema(description = "Fixed addresses assigned (from the subnet defined by \"subnetId\" if provided). See note 2. ")
