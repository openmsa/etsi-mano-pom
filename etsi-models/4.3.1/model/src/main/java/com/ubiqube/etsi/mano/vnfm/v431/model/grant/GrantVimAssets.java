...
import com.ubiqube.etsi.mano.vnfm.v431.model.grant.StorageAsset;
import com.ubiqube.etsi.mano.vnfm.v431.model.grant.VimComputeResourceFlavour;
import com.ubiqube.etsi.mano.vnfm.v431.model.grant.VimSnapshotResource;
import com.ubiqube.etsi.mano.vnfm.v431.model.grant.VimSoftwareImage;
...
/**
 * Information about assets for the VNF that are defined in VNFD and managed by the NFVO in the VIM/NFVI, such as software images and virtualised compute resource flavours. See note 3. 
 */
@Schema(description = "Information about assets for the VNF that are defined in VNFD and managed by the NFVO in the VIM/NFVI, such as software images and virtualised compute resource flavours. See note 3. ")
@Validated
...
public class GrantVimAssets   {
  ...
  @JsonProperty("storageAssets")
  @Valid
  private List<StorageAsset> storageAssets = null;
  ...
  public GrantVimAssets storageAssets(List<StorageAsset> storageAssets) {
    this.storageAssets = storageAssets;
    return this;
  }

  public GrantVimAssets addStorageAssetsItem(StorageAsset storageAssetsItem) {
    if (this.storageAssets == null) {
      this.storageAssets = new ArrayList<>();
    }
    this.storageAssets.add(storageAssetsItem);
    return this;
  }

  /**
   * Mappings between virtual storages defined in the VNFD and virtual storages managed in the NFVI. 
   * @return storageAssets
   **/
  @Schema(description = "Mappings between virtual storages defined in the VNFD and virtual storages managed in the NFVI. ")
      @Valid
    public List<StorageAsset> getStorageAssets() {
    return storageAssets;
  }

  public void setStorageAssets(List<StorageAsset> storageAssets) {
    this.storageAssets = storageAssets;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.computeResourceFlavours, grantVimAssets.computeResourceFlavours) &&
        ...
        Objects.equals(this.storageAssets, grantVimAssets.storageAssets);
  }

  @Override
  public int hashCode() {
    return Objects.hash(computeResourceFlavours, softwareImages, snapshotResources, storageAssets);
  }
  ...
  public String toString() {
    ...
    sb.append("    storageAssets: ").append(toIndentedString(storageAssets)).append("\n");
    sb.append("}");
    return sb.toString();
  }
