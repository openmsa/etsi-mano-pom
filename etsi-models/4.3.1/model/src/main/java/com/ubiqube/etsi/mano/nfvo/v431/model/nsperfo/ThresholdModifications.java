 ...
 * provisions defined in Table 7.5.2.11-1. NOTE: At least one of the attributes
 * defined in this type shall be present in request bodies.
 */
@Schema(description = "This type represents modifications to a threshold. It shall comply with the provisions defined in Table 7.5.2.11-1. NOTE: At least one of the attributes defined in this type shall be present in request bodies. ")
@Validated

public class ThresholdModifications implements AnyOfThresholdModifications {
