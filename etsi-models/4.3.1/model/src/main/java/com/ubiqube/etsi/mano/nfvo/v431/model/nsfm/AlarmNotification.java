...
import com.ubiqube.etsi.mano.nfvo.v431.model.nsfm.AlarmNotificationLinks;
 ...
 */
@Schema(description = "This type represents an alarm notification about NS faults. It shall comply with the provisions defined in Table 8.5.2.5-1. This notification shall be triggered by the NFVO when: • An alarm has been created. • An alarm has been updated, e.g. the severity of the alarm has changed. ")
@Validated
...
public class AlarmNotification   {
  ...
  public AlarmNotification timeStamp(OffsetDateTime timeStamp) {
  ...
  public AlarmNotification _links(AlarmNotificationLinks _links) {
    this._links = _links;
    return this;
  }
  ...
  public void setLinks(AlarmNotificationLinks _links) {
    this._links = _links;
  }
