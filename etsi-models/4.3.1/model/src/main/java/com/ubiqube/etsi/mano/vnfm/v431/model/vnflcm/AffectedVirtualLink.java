 ...
 * VLs, and added or removed VNF link ports. NOTE 1: When signalling the
 * addition (LINK_PORT_ADDED) or removal (LINK_PORT_REMOVED) of VNF link ports,
 * the \&quot;networkResource\&quot; and \&quot;resourceDefinitionId\&quot;
 * attributes refer to the affected virtual link instance, not the link port
 * instance. The resource handles of the affected VNF link ports can be found by
 * dereferencing the identifiers in the \&quot;vnfLinkPortIds\&quot; attribute.
 * NOTE 2: The \&quot;resourceDefinitionId\&quot; attribute provides information
 * to the API consumer (i.e. the NFVO) to assist in correlating the resource
 * changes performed during the LCM operation with the granted resources in a
 * specific Grant exchange, which is identified by the \&quot;grantId\&quot;
 * available in the \&quot;Individual VNF lifecycle management operation
 * occurrence\&quot; and the \&quot;id\&quot; in the \&quot;Individual
 * Grant\&quot;.
 */
...
public class AffectedVirtualLink {
	 ...
	 * \"vnfVirtualLinkResource¬Info\" or \"extManagedVirtualLinkInfo\" attribute in
	 * the \"VnfInstance\" structure. See note 1.
	 *
