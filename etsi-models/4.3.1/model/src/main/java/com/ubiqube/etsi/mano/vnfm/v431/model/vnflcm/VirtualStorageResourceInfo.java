 ...
 * resource that is used by a VNF instance. Note: If only the value or the
 * presence of this attribute is changed in the
 * \&quot;VirtualStorageResourceInfo\&quot; structure by an LCM operation
 * occurrence, this does not represent a change that requires including a
 * related \&quot;AffectedVirtualStorage\&quot; structure in the VNF LCM
 * operation occurrence notifications or the \&quot;VnfLcmOpOcc\&quot; structure
 * related to this LCM operation occurrence.
 */
@Schema(description = "This type represents the information that allows addressing a virtualised resource that is used by a VNF instance. Note: If only the value or the presence of this attribute is changed in the \"VirtualStorageResourceInfo\"       structure by an LCM operation occurrence, this does not represent a change that requires       including a related \"AffectedVirtualStorage\" structure in the VNF LCM operation occurrence       notifications or the \"VnfLcmOpOcc\" structure related to this LCM operation occurrence. ")
@Validated
...
public class VirtualStorageResourceInfo {
	...
	public VirtualStorageResourceInfo zoneId(final String zoneId) {
		this.zoneId = zoneId;
		return this;
	}
