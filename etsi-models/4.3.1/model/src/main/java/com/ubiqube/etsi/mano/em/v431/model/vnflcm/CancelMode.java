...
import com.ubiqube.etsi.mano.em.v431.model.vnflcm.CancelModeType;
 ...
 */
@Schema(description = "This type represents a parameter to select the mode of cancelling an ongoing VNF LCM operation occurrence. ")
@Validated
