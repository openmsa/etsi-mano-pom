...
import com.ubiqube.etsi.mano.vnfm.v431.model.grant.CpProtocolData;
...
public class VnfExtCpConfig  implements AnyOfVnfExtCpConfig {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(parentCpConfigId, linkPortId, createExtLinkPort, netAttDefResourceId, cpProtocolData);
  }
