...
import com.ubiqube.etsi.mano.nfvo.v431.model.nsfm.AdditionalResourceInfo;
...
public class ResourceHandle   {
  ...
  /**
   * Additional resource information which is specific to this resource and its type, and which  is available from the VIM or the CISM or the resource provider. See note 1. 
  ...
  @Override
  public int hashCode() {
    return Objects.hash(vimId, resourceProviderId, resourceId, vimLevelResourceType, vimLevelAdditionalResourceInfo, containerNamespace);
  }
