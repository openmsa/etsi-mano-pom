...
/**
 * This type represents the information of a VNF snapshot package. NOTE: The
 * attribute shall not be present before the VNF snapshot package content has
 * been uploaded or built. Otherwise, this attribute shall be present unless it
 * has been requested to be excluded per attribute selector.
 */
@Schema(description = "This type represents the information of a VNF snapshot package. NOTE: The attribute shall not be present before the VNF snapshot package content has been uploaded or built.       Otherwise, this attribute shall be present unless it has been requested to be excluded per attribute selector. ")
@Validated
...
public class VnfSnapshotPkgInfo {
	 ...
	 * upload is completed). - PROCESSING: the VNF snapshot is being processed. -
	 * ERROR: failure during the VNF snapshot package building, uploading or
	 * processing. - ERROR_EXTRACTING: failure during the VNF snapshot package
	 * extraction task.
	 */
	...
	public VnfSnapshotPkgInfo checksum(final String checksum) {
	...
	/**
	 * Identifiers of information held by the VNFM about specific VNFC snapshots
