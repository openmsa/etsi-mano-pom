...
public class VnfLinkPortInfo {
	 ...
	 * values: - VNFC_CP: The link port is connected to a VNFC CP. - EXT_CP: The
	 * link port is associated to an external CP. See note 1.
	 */
	...
	public VnfLinkPortInfo vipCpInstanceId(final String vipCpInstanceId) {
	...
	public void setVipCpInstanceId(final String vipCpInstanceId) {
		this.vipCpInstanceId = vipCpInstanceId;
	}

	public VnfLinkPortInfo trunkResourceId(final String trunkResourceId) {
