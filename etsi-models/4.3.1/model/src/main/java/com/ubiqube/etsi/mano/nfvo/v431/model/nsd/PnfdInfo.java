...
public class PnfdInfo {
	...
	@JsonProperty("pnfdExtInvariantId")
	private String pnfdExtInvariantId = null;
	...
	public PnfdInfo pnfdVersion(final String pnfdVersion) {
	...
	public void setPnfdVersion(final String pnfdVersion) {
		this.pnfdVersion = pnfdVersion;
	}
	...
	public PnfdInfo pnfdExtInvariantId(final String pnfdExtInvariantId) {
		this.pnfdExtInvariantId = pnfdExtInvariantId;
		return this;
	}

	/**
	 * Get pnfdExtInvariantId
	 *
	 * @return pnfdExtInvariantId
	 **/
	@Schema(description = "")

	public String getPnfdExtInvariantId() {
		return pnfdExtInvariantId;
	}

	public void setPnfdExtInvariantId(final String pnfdExtInvariantId) {
		this.pnfdExtInvariantId = pnfdExtInvariantId;
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.id, pnfdInfo.id) &&
				...
				Objects.equals(this.pnfdExtInvariantId, pnfdInfo.pnfdExtInvariantId) &&
	...
	public String toString() {
		...
		sb.append("    pnfdExtInvariantId: ").append(toIndentedString(pnfdExtInvariantId)).append("\n");
