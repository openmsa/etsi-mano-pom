...
import com.ubiqube.etsi.mano.nfvo.v431.model.nsfm.AlarmListRebuiltNotificationLinks;
 ...
 */
@Schema(description = "This type represents a notification that the alarm list has been rebuilt, e.g. if the NFVO detects its storage holding the alarm list is corrupted. It shall comply with the provisions defined in Table 8.5.2.7-1. The notification shall be triggered by the NFVO when the alarm list has been rebuilt, e.g. because the NFVO has detected  that its storage holding the alarm list was corrupted. ")
@Validated
...
public class AlarmListRebuiltNotification   {
  ...
  public AlarmListRebuiltNotification timeStamp(OffsetDateTime timeStamp) {
  ...
  public AlarmListRebuiltNotification _links(AlarmListRebuiltNotificationLinks _links) {
    this._links = _links;
    return this;
  }
  ...
  public void setLinks(AlarmListRebuiltNotificationLinks _links) {
    this._links = _links;
  }
