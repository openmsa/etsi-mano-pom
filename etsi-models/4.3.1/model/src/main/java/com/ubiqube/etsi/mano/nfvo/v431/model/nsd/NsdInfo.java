 ...
 */
package com.ubiqube.etsi.mano.nfvo.v431.model.nsd;
...
/**
 * This type represents a response for the query NSD operation. NOTE 1: At least
 * one of the attributes - vnfPkgId and nestedNsdInfoId shall be present, after
 * the NSD is on-boarded. NOTE 2: If the value of the nsdOnboardingState
 * attribute is not equal to \&quot;ONBOARDED\&quot;, the value of the
 * nsdOperationalState attribute shall be equal to \&quot;DISABLED\&quot;. NOTE
 * 3: If the value of the nsdOnboardingState attribute is not equal to
 * \&quot;ONBOARDED\&quot;, the value of the nsdUsageState attribute shall be
 * equal to \&quot;NOT_IN_USE\&quot;. NOTE 4: State changes of an NSD are
 * illustrated in clause B.2. NOTE 5: This attribute shall be present after the
 * NSD is on-boarded for those VNF packages that are already on-boarded. NOTE 6:
 * This attribute shall be present after the NSD is on-boarded for those PNFDs
 * that are already on-boarded. NOTE 7: This attribute shall be present after
 * the NSD is on-boarded for those nested NSDs that are already on-boarded.
 */
@Schema(description = "This type represents a response for the query NSD operation. NOTE 1: At least one of the attributes - vnfPkgId and nestedNsdInfoId shall be present, after the NSD is on-boarded. NOTE 2: If the value of the nsdOnboardingState attribute is not equal to \"ONBOARDED\", the value of the nsdOperationalState attribute shall be equal to \"DISABLED\". NOTE 3: If the value of the nsdOnboardingState attribute is not equal to \"ONBOARDED\", the value of the nsdUsageState attribute shall be equal to \"NOT_IN_USE\". NOTE 4: State changes of an NSD are illustrated in clause B.2. NOTE 5: This attribute shall be present after the NSD is on-boarded for those VNF packages that are already on-boarded. NOTE 6: This attribute shall be present after the NSD is on-boarded for those PNFDs that are already on-boarded. NOTE 7: This attribute shall be present after the NSD is on-boarded for those nested NSDs that are already on-boarded.")
@Validated
...
public class NsdInfo implements AnyOfNsdInfo {
	...
	@JsonProperty("nsdExtInvariantId")
	private String nsdExtInvariantId = null;
	 ...
	 * of ETSI GS NFV SOL 007. It shall be present after the VNF package content has
	...
	public NsdInfo nsdExtInvariantId(final String nsdExtInvariantId) {
		this.nsdExtInvariantId = nsdExtInvariantId;
		return this;
	}

	/**
	 * Get nsdExtInvariantId
	 *
	 * @return nsdExtInvariantId
	 **/
	@Schema(description = "")

	public String getNsdExtInvariantId() {
		return nsdExtInvariantId;
	}

	public void setNsdExtInvariantId(final String nsdExtInvariantId) {
		this.nsdExtInvariantId = nsdExtInvariantId;
	}
	 ...
	 * descriptor resource. See notes 1 and 5.
	 *
	 * @return vnfPkgIds
	 **/
	@Schema(description = "Identifies the VNF package for the VNFD referenced by the on-boarded NS descriptor resource. See notes 1 and 5. ")
	 ...
	 * descriptor resource. See note 6.
	 *
	 * @return pnfdInfoIds
	 **/
	@Schema(description = "Identifies the PnfdInfo element for the PNFD referenced by the on-boarded NS descriptor resource. See note 6. ")
	 ...
	 * on-boarded NS descriptor resource. See notes 1 and 7.
	 *
	 * @return nestedNsdInfoIds
	 **/
	@Schema(description = "Identifies the NsdInfo element for the nested NSD referenced by the on-boarded NS descriptor resource. See notes 1 and 7. ")
	 ...
	 **/
	@Schema(description = "Signals the security option used by the NSD archive as defined in clause 5.1 of ETSI GS NFV SOL 007. It shall be present after the VNF package content has been on-boarded and absent otherwise. Valid values: - OPTION_1 - OPTION_2 ")
	...
	public boolean equals(final java.lang.Object o) {
		...
		return Objects.equals(this.id, nsdInfo.id) &&
				...
				Objects.equals(this.nsdExtInvariantId, nsdInfo.nsdExtInvariantId) &&
	...
	public String toString() {
		...
		sb.append("    nsdExtInvariantId: ").append(toIndentedString(nsdExtInvariantId)).append("\n");
