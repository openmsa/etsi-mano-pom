 ...
 */
@Schema(description = "This type represents attribute modifications for an \"Individual VNF snapshot\" resource, i.e. modifications  to a resource representation based on the \"VnfSnapshotInfo\" data type. The attributes of \"VnfSnapshotInfo\"  that can be modified according to the provisions in clause 5.5.2.22 are included in the  \"VnfSnapshotInfoModificationRequest\" data type. ")
@Validated
