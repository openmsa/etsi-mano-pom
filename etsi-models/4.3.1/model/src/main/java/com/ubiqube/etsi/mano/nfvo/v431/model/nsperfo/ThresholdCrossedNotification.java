 ...
 * crossed. NOTE: The sub-object allows to structure the measured object but is
 * not to be confused with sub-counters which allow to structure the
 * measurement.
 */
@Schema(description = "This type represents a notification that is sent when a threshold has been crossed. NOTE: The sub-object allows to structure the measured object but is not to be confused with sub-counters which allow to structure the measurement. ")
@Validated
...
public class ThresholdCrossedNotification {
	...
	public ThresholdCrossedNotification notificationType(final String notificationType) {
