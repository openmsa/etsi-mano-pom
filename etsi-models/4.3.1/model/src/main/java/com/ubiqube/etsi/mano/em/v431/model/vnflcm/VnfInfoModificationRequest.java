...
public class VnfInfoModificationRequest {
	 ...
	 * \"newList\" as defined below this table. The following provisions shall apply
	 * when modifying an attribute that is an array of objects of type \"VnfcInfo\"
	 * by supplying an array of objects of type \"VnfcInfoModifications\".
	 * Assumptions: 1) \"oldList\" is the \"VnfcInfo\" array to be modified and
	 * \"newList\" is the \"VnfcInfoModifications\" array that contains the changes.
	...
	@Override
	public int hashCode() {
		return Objects.hash(vnfInstanceName, vnfInstanceDescription, vnfdId, vnfConfigurableProperties, metadata, extensions, vnfcInfoModifications);
	}
