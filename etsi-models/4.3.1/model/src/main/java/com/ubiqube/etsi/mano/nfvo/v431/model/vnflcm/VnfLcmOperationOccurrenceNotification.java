...
import com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.LcmOpOccNotificationVerbosityType;
import com.ubiqube.etsi.mano.nfvo.v431.model.nslcm.ModificationsTriggeredByVnfPkgChange;
 ...
 * lifecycle, which represents an occurrence of one the following LCM
 * operations: - Instantiation of the VNF - Scaling of the VNF instance
 ...
 * connectivity of the VNF instance - Change of the current VNF package -
 * Termination of the VNF instance - Modification of VNF instance information
 * and/or VNF configurable properties through the \&quot;PATCH\&quot; method on
 * the \&quot;Individual VNF instance\&quot; resource - Creation of a VNF
 * snapshot - Reversion of the VNF instance to a VNF snapshot Clause 5.6.2
 * defines the states and state transition of a VNF LCM operation occurrence,
 * and also specifies details of the notifications to be emitted at each state
