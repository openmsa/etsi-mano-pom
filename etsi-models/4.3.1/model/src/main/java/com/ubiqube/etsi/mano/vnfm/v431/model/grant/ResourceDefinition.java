 ...
 * the VNF. NOTE 1: The use cases UC#4 and UC#5 in Annex A.4 of ETSI GS NFV-IFA
 * 007 provide examples for such a configuration. NOTE 2: In the context of an
 * operation that changes the current VNF package, the following applies: If
 * this ResourceDefinition is related to a resource to be created or modified,
 * the \&quot;vnfdId\&quot; attribute shall contain the identifier of the
...
public class ResourceDefinition {
	 ...
	 * * STORAGE * LINKPORT * OSCONTAINER * VIRTUALCP
	 */
	...
	/**
	 * Reference to the applicable resource template in the VNFD as follows: - if
	 * type=\"VL\" : VnfVirtualLinkDesc - if type=\"COMPUTE\": VirtualComputeDesc -
	 * if type=\"LINKPORT\" : VnfExtCpd - if type=\"STORAGE\" : VirtualStorageDesc -
	 * If type=\"OSCONTAINER\": OsContainerDesc - Cardinality may be greater than
	 * \"1\" when type=\"OSCONTAINER\" and multiple references to OsContainerDesc
	 * are present in the VDU indicated by the \"vduId\". Cardinality shall be \"1\"
	 * otherwise.
	 *
