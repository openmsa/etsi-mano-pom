 ...
 */
package com.ubiqube.etsi.mano.nfvo.v431.controller.vnfsnapshotpkgm;
...
import com.ubiqube.etsi.mano.nfvo.v431.model.vnfsnapshotpkgm.ExtractVnfSnapshotPkgRequest;
import com.ubiqube.etsi.mano.nfvo.v431.model.vnfsnapshotpkgm.UploadVnfSnapshotPkgFromUriRequest;
import com.ubiqube.etsi.mano.nfvo.v431.model.vnfsnapshotpkgm.VnfSnapshotPkgExtArtifactsAccessConfig;
...
public class VnfSnapshotPackages431Sol005Controller implements VnfSnapshotPackages431Sol005Api {
	...
	public VnfSnapshotPackages431Sol005Controller(final VnfSnapshotPackagesFrontController vnfSnapshotPackagesFrontController) {
	...
	public ResponseEntity<String> vnfSnapshotPackagesGet(final MultiValueMap<String, String> requestParams, @Valid final String nextpageOpaqueMarker) {
		return frontController.search(requestParams, VnfSnapshotPkgInfo.class, VnfSnapshotPackages431Sol005Controller::makeLinks);
	}
