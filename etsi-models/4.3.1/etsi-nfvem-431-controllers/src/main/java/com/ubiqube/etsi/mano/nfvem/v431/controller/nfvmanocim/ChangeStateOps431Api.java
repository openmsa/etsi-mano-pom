...
import com.ubiqube.etsi.mano.nfvem.v431.model.nfvmanologm.ProblemDetails;
...
public interface ChangeStateOps431Api {
	...
	ResponseEntity<ChangeStateOpOcc> changeStateOpsChangeStateOpOccIdGet(
			@Parameter(in = ParameterIn.PATH, description = "Identifier of the change state operation occurrence ", required = true, schema = @Schema()) @PathVariable("changeStateOpOccId") String changeStateOpOccId);

	@Operation(summary = "", description = "The API consumer can use the GET method to query status information  about multiple change state operation occurrences. See clause 5.5.8.3.2. ", tags = {})
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "200 OK Shall be returned when status information for zero or more \"change state operation occurrences\" has been queried successfully. The response body shall contain in an array the status information about zero or more \"Individual change state operation occurrences\", as defined in clause 5.6.2.9. If the “filter\" URI parameter or one of the \"all_fields\", \"fields\" (if supported), \"exclude_fields\" (if supported) or \"exclude_default\" URI parameters was supplied in the request, the data in the response body shall have been transformed according to the rules specified in clauses 5.2.2 and 5.3.2 of ETSI GS NFV-SOL 013, respectively. If the NFV-MANO functional entity supports alternative N°2 (paging) according to clause 5.4.2.1 of ETSI GS NFV-SOL 013 for this resource, inclusion of the Link HTTP header in this response shall follow the provisions in clause 5.4.2.3 of ETSI GS NFV-SOL 013. ", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = ChangeStateOpOcc.class)))),

			@ApiResponse(responseCode = "400", description = "400 BAD REQUEST Shall be returned upon the following errors:   - Invalid attribute-based filtering expression.     The response body shall contain a ProblemDetails structure, in which     the \"detail\" attribute should convey more information about the error.   - Invalid attribute selector.     The response body shall contain a ProblemDetails structure, in which     the \"detail\" attribute should convey more information about the error.   - Response too big.     If the NFV-MANO functional entity supports alternative N°1 (error)     according to clause 5.4.2.1 of ETSI GS NFV-SOL 013 for this resource,     this error response shall follow the provisions in clause 5.4.2.2 of     ETSI GS NFV-SOL 013.     headers: WWW-Authenticate:   description: >     Challenge if the corresponding HTTP request has not provided     authorization, or error details if the corresponding HTTP     request has provided an invalid authorization token.   schema:     type: string Version:   description: >     Version of the API used in the response.   schema:     type: string ", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProblemDetails.class))),
	...
	ResponseEntity<List<ChangeStateOpOcc>> changeStateOpsGet(
			@Parameter(in = ParameterIn.QUERY, description = "Attribute-based filtering expression according to clause 5.2 of  ETSI GS NFV-SOL 013.  The NFV-MANO functional entity shall support receiving this parameter  as part of the URI query string. The API consumer may supply this  parameter.  All attribute names that appear in the ChangeStateOpOcc and in data  types referenced from it shall be supported by the NFV-MANO functional  entity in the expression.  ", schema = @Schema()) @Valid @RequestParam(value = "filter", required = false) String filter,
			...
			@Parameter(in = ParameterIn.QUERY, description = "Indicates to exclude the following complex attributes from the  response. See clause 5.3 of ETSI GS NFV-SOL 013 for details.  The NFV-MANO functional entity shall support this parameter. The following attributes shall be excluded from the ChangeStateOpOcc  structure in the response body if this parameter is provided, or none of  the parameters \"all_fields,\" \"fields\", \"exclude_fields\", \"exclude_default\"  are provided: - operationParams ", schema = @Schema()) @Valid @RequestParam(value = "exclude_default", required = false) String excludeDefault,
