...
public class NsDescriptorGenericFrontControllerImpl implements NsDescriptorGenericFrontController {
	 ...
	 */
	@Override
	public <U> ResponseEntity<String> search(@RequestParam final MultiValueMap<String, String> requestParams, final Function<NsdPackage, U> mapper, final Consumer<U> makeLink, final Class<?> frontClass) {
