...
@RequestMapping("/meo/app_pkgm/v1/onboarded_app_packages")
public interface OnboardedAppPackages211MepmApi {
	...
	@RequestMapping(value = "/{appDId}/appd", produces = { "text/plain", "application/zip", "application/json" }, method = RequestMethod.GET)
	...
	@ApiResponses(value = {
			...
			@ApiResponse(code = 406, message = "Not Acceptable : used to indicate that the server cannot provide the any of the content formats supported by the client.", response = ProblemDetails.class),
			@ApiResponse(code = 429, message = "Too Many Requests : used when a rate limiter has triggered.", response = ProblemDetails.class) })
	@RequestMapping(value = "/{appDId}/package_content", produces = { "application/json" }, method = RequestMethod.GET)
	ResponseEntity<Resource> appDIdGET(@ApiParam(value = "Identifier of an application descriptor", required = true) @PathVariable("appDId") String appDId);
	...
	@ApiResponses(value = {
			...
			@ApiResponse(code = 429, message = "Too Many Requests : used when a rate limiter has triggered.", response = ProblemDetails.class) })
	@RequestMapping(value = "/{appDId}/package_content", produces = { "application/json" }, consumes = { "application/zip" }, method = RequestMethod.PUT)
