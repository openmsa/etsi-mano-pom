 ...
 */
@ApiModel(description = "Additional information of application package artifacts that are not application software images. Type is TBD")
@Validated
public class AppPkgArtifactInfo   {
  ...
  public String toString() {
    ...
    sb.append("class AppPkgArtifactInfo {\n");
