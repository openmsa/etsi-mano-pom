 ...
 *
 */
public class VirtualTaskConnectivityV2<U> {
	...
	public VirtualTaskConnectivityV2() {
		// Nothing.
	}

	public VirtualTaskConnectivityV2(final VirtualTaskV3<U> source, final VirtualTaskV3<U> target) {
		this.source = source;
		this.target = target;
	}

	public VirtualTaskConnectivityV2(final VirtualTaskV3<U> source, final VirtualTaskV3<U> target, final Relation relation) {
		this.source = source;
		this.target = target;
